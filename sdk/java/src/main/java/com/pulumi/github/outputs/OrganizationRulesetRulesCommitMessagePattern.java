...
@CustomType
public final class OrganizationRulesetRulesCommitMessagePattern {
    /**
    ...
    public static Builder builder(OrganizationRulesetRulesCommitMessagePattern defaults) {
    ...
    public static final class Builder {
        ...
        private String pattern;
        public Builder() {}
        public Builder(OrganizationRulesetRulesCommitMessagePattern defaults) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("OrganizationRulesetRulesCommitMessagePattern", "operator");
            }
        ...
        public Builder pattern(String pattern) {
            if (pattern == null) {
              throw new MissingRequiredPropertyException("OrganizationRulesetRulesCommitMessagePattern", "pattern");
            }
