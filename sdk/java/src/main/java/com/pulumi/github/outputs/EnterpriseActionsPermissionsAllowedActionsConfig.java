...
@CustomType
public final class EnterpriseActionsPermissionsAllowedActionsConfig {
    /**
    ...
    public static Builder builder(EnterpriseActionsPermissionsAllowedActionsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean verifiedAllowed;
        public Builder() {}
        public Builder(EnterpriseActionsPermissionsAllowedActionsConfig defaults) {
        ...
        public Builder githubOwnedAllowed(Boolean githubOwnedAllowed) {
            if (githubOwnedAllowed == null) {
              throw new MissingRequiredPropertyException("EnterpriseActionsPermissionsAllowedActionsConfig", "githubOwnedAllowed");
            }
        ...
        public EnterpriseActionsPermissionsAllowedActionsConfig build() {
            final var _resultValue = new EnterpriseActionsPermissionsAllowedActionsConfig();
