...
public final class CodespacesSecretArgs extends com.pulumi.resources.ResourceArgs {

    public static final CodespacesSecretArgs Empty = new CodespacesSecretArgs();
    ...
    private CodespacesSecretArgs(CodespacesSecretArgs $) {
    ...
    public static Builder builder(CodespacesSecretArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CodespacesSecretArgs();
        }

        public Builder(CodespacesSecretArgs defaults) {
            $ = new CodespacesSecretArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CodespacesSecretArgs build() {
            if ($.repository == null) {
                throw new MissingRequiredPropertyException("CodespacesSecretArgs", "repository");
            }
            if ($.secretName == null) {
                throw new MissingRequiredPropertyException("CodespacesSecretArgs", "secretName");
            }
            return $;
        }
    }
