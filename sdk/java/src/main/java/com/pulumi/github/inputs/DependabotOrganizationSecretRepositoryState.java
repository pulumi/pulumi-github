...
public final class DependabotOrganizationSecretRepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final DependabotOrganizationSecretRepositoryState Empty = new DependabotOrganizationSecretRepositoryState();
    ...
    private DependabotOrganizationSecretRepositoryState() {}

    private DependabotOrganizationSecretRepositoryState(DependabotOrganizationSecretRepositoryState $) {
    ...
    public static Builder builder(DependabotOrganizationSecretRepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DependabotOrganizationSecretRepositoryState();
        }

        public Builder(DependabotOrganizationSecretRepositoryState defaults) {
            $ = new DependabotOrganizationSecretRepositoryState(Objects.requireNonNull(defaults));
        }
        ...
        public DependabotOrganizationSecretRepositoryState build() {
            return $;
        }
    }
