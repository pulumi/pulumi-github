...
public final class RepositoryRulesetRulesRequiredStatusChecksRequiredCheck {
    ...
    public static Builder builder(RepositoryRulesetRulesRequiredStatusChecksRequiredCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer integrationId;
        public Builder() {}
        public Builder(RepositoryRulesetRulesRequiredStatusChecksRequiredCheck defaults) {
        ...
        public Builder context(String context) {
            if (context == null) {
              throw new MissingRequiredPropertyException("RepositoryRulesetRulesRequiredStatusChecksRequiredCheck", "context");
            }
