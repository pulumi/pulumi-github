...
public final class DependabotSecretState extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(DependabotSecretState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DependabotSecretState();
        }

        public Builder(DependabotSecretState defaults) {
            $ = new DependabotSecretState(Objects.requireNonNull(defaults));
        }
