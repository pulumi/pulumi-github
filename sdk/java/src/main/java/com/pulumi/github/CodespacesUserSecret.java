...
public class CodespacesUserSecret extends com.pulumi.resources.CustomResource {
     ...
     */
    public CodespacesUserSecret(java.lang.String name) {
     ...
     */
    public CodespacesUserSecret(java.lang.String name, CodespacesUserSecretArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CodespacesUserSecret(java.lang.String name, CodespacesUserSecretArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("github:index/codespacesUserSecret:CodespacesUserSecret", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CodespacesUserSecret(java.lang.String name, Output<java.lang.String> id, @Nullable CodespacesUserSecretState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("github:index/codespacesUserSecret:CodespacesUserSecret", name, state, makeResourceOptions(options, id), false);
    }

    private static CodespacesUserSecretArgs makeArgs(CodespacesUserSecretArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CodespacesUserSecretArgs.Empty : args;
    }
     ...
     */
    public static CodespacesUserSecret get(java.lang.String name, Output<java.lang.String> id, @Nullable CodespacesUserSecretState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
