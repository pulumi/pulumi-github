...
public final class GetCodespacesOrganizationSecretsSecret {
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetCodespacesOrganizationSecretsSecret", "createdAt");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCodespacesOrganizationSecretsSecret", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetCodespacesOrganizationSecretsSecret", "updatedAt");
            }
        ...
        public Builder visibility(String visibility) {
            if (visibility == null) {
              throw new MissingRequiredPropertyException("GetCodespacesOrganizationSecretsSecret", "visibility");
            }
