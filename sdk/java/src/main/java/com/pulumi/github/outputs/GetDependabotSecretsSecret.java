...
public final class GetDependabotSecretsSecret {
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetDependabotSecretsSecret", "createdAt");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDependabotSecretsSecret", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetDependabotSecretsSecret", "updatedAt");
            }
