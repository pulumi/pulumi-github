...
public class OrganizationSecurityManager extends com.pulumi.resources.CustomResource {
    ...
    private OrganizationSecurityManager(String name, Output<String> id, @Nullable OrganizationSecurityManagerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationSecurityManager get(String name, Output<String> id, @Nullable OrganizationSecurityManagerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
