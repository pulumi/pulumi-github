...
@CustomType
public final class RepositoryRulesetRulesBranchNamePattern {
    /**
    ...
    private RepositoryRulesetRulesBranchNamePattern() {}
    /**
     * @return (String) The name of the ruleset.
     * 
     */
    ...
    public static Builder builder(RepositoryRulesetRulesBranchNamePattern defaults) {
    ...
    public static final class Builder {
        ...
        private String pattern;
        public Builder() {}
        public Builder(RepositoryRulesetRulesBranchNamePattern defaults) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("RepositoryRulesetRulesBranchNamePattern", "operator");
            }
        ...
        public Builder pattern(String pattern) {
            if (pattern == null) {
              throw new MissingRequiredPropertyException("RepositoryRulesetRulesBranchNamePattern", "pattern");
            }
