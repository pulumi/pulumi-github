...
import com.pulumi.github.outputs.RepositoryBranch;
...
public class Repository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="branches", type=List.class, parameters={RepositoryBranch.class})
    private Output<List<RepositoryBranch>> branches;

    /**
     * @return The list of this repository&#39;s branches. Each element of `branches` has the following attributes:
     * 
     */
    public Output<List<RepositoryBranch>> branches() {
