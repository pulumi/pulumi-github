...
public final class GetRepositoryWebhooksWebhook {
    ...
    public static final class Builder {
        ...
        public Builder active(Boolean active) {
            if (active == null) {
              throw new MissingRequiredPropertyException("GetRepositoryWebhooksWebhook", "active");
            }
            this.active = active;
            return this;
        }
        ...
        public Builder id(Integer id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetRepositoryWebhooksWebhook", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetRepositoryWebhooksWebhook", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetRepositoryWebhooksWebhook", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetRepositoryWebhooksWebhook", "url");
            }
            this.url = url;
            return this;
        }
