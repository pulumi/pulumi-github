...
public final class RepositoryRulesetRulesBranchNamePatternArgs extends com.pulumi.resources.ResourceArgs {

    public static final RepositoryRulesetRulesBranchNamePatternArgs Empty = new RepositoryRulesetRulesBranchNamePatternArgs();
    ...
    private RepositoryRulesetRulesBranchNamePatternArgs(RepositoryRulesetRulesBranchNamePatternArgs $) {
        this.name = $.name;
        this.negate = $.negate;
    ...
    public static Builder builder(RepositoryRulesetRulesBranchNamePatternArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RepositoryRulesetRulesBranchNamePatternArgs();
        }

        public Builder(RepositoryRulesetRulesBranchNamePatternArgs defaults) {
            $ = new RepositoryRulesetRulesBranchNamePatternArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RepositoryRulesetRulesBranchNamePatternArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("RepositoryRulesetRulesBranchNamePatternArgs", "operator");
            }
            if ($.pattern == null) {
                throw new MissingRequiredPropertyException("RepositoryRulesetRulesBranchNamePatternArgs", "pattern");
            }
            return $;
        }
    }
