...
public final class RepositoryRulesetConditionsRefName {
    ...
    public static Builder builder(RepositoryRulesetConditionsRefName defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> includes;
        public Builder() {}
        public Builder(RepositoryRulesetConditionsRefName defaults) {
        ...
        public Builder excludes(List<String> excludes) {
            if (excludes == null) {
              throw new MissingRequiredPropertyException("RepositoryRulesetConditionsRefName", "excludes");
            }
        ...
        public Builder includes(List<String> includes) {
            if (includes == null) {
              throw new MissingRequiredPropertyException("RepositoryRulesetConditionsRefName", "includes");
            }
