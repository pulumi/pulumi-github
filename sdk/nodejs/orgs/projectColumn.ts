 ...
 * 
 * const project = new github.orgs.Project("project", {
 *     body: "This is an organization project.",
 * });
 * const column = new github.orgs.ProjectColumn("column", {
...
export class ProjectColumn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'github:orgs/projectColumn:ProjectColumn';
