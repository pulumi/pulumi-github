...
export class Team extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'github:teams/team:Team';
     ...
     * Defaults to `secret`.
     */
    public readonly privacy!: pulumi.Output<Privacy | undefined>;
    /**
...
export interface TeamState {
     ...
     * Defaults to `secret`.
     */
    readonly privacy?: pulumi.Input<Privacy>;
    /**
     * The slug of the created team, which may or may not differ from `name`,
     * depending on whether `name` contains "URL-unsafe" characters.
     * Useful when referencing the team in [`github_branch_protection`](https://www.terraform.io/docs/providers/github/r/branch_protection.html).
