...
class EnterpriseActionsPermissionsArgs:
    ...
    def enabled_organizations(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def enabled_organizations(self, value: pulumi.Input[_builtins.str]):
...
class EnterpriseActionsPermissions(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enabledOrganizations")
    def enabled_organizations(self) -> pulumi.Output[_builtins.str]:
        """
        The policy that controls the organizations in the enterprise that are allowed to run GitHub Actions. Can be one of: `all`, `none`, or `selected`.
        """
        return pulumi.get(self, "enabled_organizations")
