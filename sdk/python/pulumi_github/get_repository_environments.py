...
def get_repository_environments(repository: Optional[_builtins.str] = None,
    ...
    :param _builtins.str repository: Name of the repository to retrieve the environments from.
    """
    __args__ = dict()
