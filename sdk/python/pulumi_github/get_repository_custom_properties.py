...
def get_repository_custom_properties(repository: Optional[_builtins.str] = None,
    ...
    :param _builtins.str repository: Name of the repository to retrieve the custom properties from.
    """
    __args__ = dict()
