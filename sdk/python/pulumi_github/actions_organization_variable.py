...
class ActionsOrganizationVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] variable_name: Name of the variable
        :param pulumi.Input[builtins.str] visibility: Configures the access that repositories have to the organization variable.
               Must be one of `all`, `private`, `selected`. `selected_repository_ids` is required if set to `selected`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] selected_repository_ids: An array of repository ids that can access the organization variable.
        """
...
class _ActionsOrganizationVariableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Date of actions_variable creation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] selected_repository_ids: An array of repository ids that can access the organization variable.
        :param pulumi.Input[builtins.str] updated_at: Date of actions_variable update.
        :param pulumi.Input[builtins.str] value: Value of the variable
        :param pulumi.Input[builtins.str] variable_name: Name of the variable
        :param pulumi.Input[builtins.str] visibility: Configures the access that repositories have to the organization variable.
               Must be one of `all`, `private`, `selected`. `selected_repository_ids` is required if set to `selected`.
...
class ActionsOrganizationVariable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            value: Optional[pulumi.Input[builtins.str]] = None,
            variable_name: Optional[pulumi.Input[builtins.str]] = None,
            visibility: Optional[pulumi.Input[builtins.str]] = None) -> 'ActionsOrganizationVariable':
        """
