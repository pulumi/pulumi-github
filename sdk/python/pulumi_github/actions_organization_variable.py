...
class ActionsOrganizationVariable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        The following import imports a GitHub actions organization variable named `myvariable`to a `ActionsOrganizationVariable` resource named `example`.
    ...
    def get(resource_name: str,
            ...
            value: pulumi.Input[Optional[_builtins.str]] = None,
            variable_name: pulumi.Input[Optional[_builtins.str]] = None,
            visibility: pulumi.Input[Optional[_builtins.str]] = None) -> 'ActionsOrganizationVariable':
        """
