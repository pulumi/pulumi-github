...
class GetRepositoriesResult:
    ...
    def full_names(self) -> Sequence[builtins.str]:
    ...
    def include_repo_id(self) -> Optional[builtins.bool]:
    ...
    def repo_ids(self) -> Sequence[builtins.int]:
        """
...
def get_repositories(include_repo_id: Optional[builtins.bool] = None,
    ...
    :param builtins.bool include_repo_id: Returns a list of found repository IDs
    :param builtins.str query: Search query. See [documentation for the search syntax](https://help.github.com/articles/understanding-the-search-syntax/).
    :param builtins.int results_per_page: Set the number of repositories requested per API call. Can be useful to decrease if requests are timing out or to increase to reduce the number of API calls. Defaults to 100.
    :param builtins.str sort: Sorts the repositories returned by the specified attribute. Valid values include `stars`, `fork`, and `updated`. Defaults to `updated`.
    """
    __args__ = dict()
...
def get_repositories_output(include_repo_id: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
