...
def get_repository_pull_requests(base_ref: Optional[builtins.str] = None,
                                 base_repository: Optional[builtins.str] = None,
    ...
    :param builtins.str base_repository: Name of the base repository to retrieve the Pull Requests from.
    ...
    :param builtins.str owner: Owner of the repository. If not provided, the provider's default owner is used.
    :param builtins.str sort_by: If set, indicates what to sort results by. Can be either "created", "updated", "popularity" (comment count) or "long-running" (age, filtering by pulls updated in the last month). Default: "created".
    :param builtins.str sort_direction: If set, controls the direction of the sort. Can be either "asc" or "desc". Default: "asc".
...
def get_repository_pull_requests_output(base_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        base_repository: Optional[pulumi.Input[builtins.str]] = None,
                                        head_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
