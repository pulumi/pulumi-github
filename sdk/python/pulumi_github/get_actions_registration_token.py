...
def get_actions_registration_token(repository: Optional[builtins.str] = None,
    ...
    :param builtins.str repository: Name of the repository to get a GitHub Actions registration token for.
    """
    __args__ = dict()
...
def get_actions_registration_token_output(repository: Optional[pulumi.Input[builtins.str]] = None,
