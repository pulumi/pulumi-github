...
class BranchDefaultArgs:
    def __init__(__self__, *,
                 ...
                 rename: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a BranchDefault resource.
        :param pulumi.Input[builtins.str] branch: The branch (e.g. `main`)
        :param pulumi.Input[builtins.str] repository: The GitHub repository
        :param pulumi.Input[builtins.bool] rename: Indicate if it should rename the branch rather than use an existing branch. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter
    def rename(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @rename.setter
    def rename(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BranchDefault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[builtins.str]] = None,
            rename: Optional[pulumi.Input[builtins.bool]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None) -> 'BranchDefault':
        """
    ...
    @property
    @pulumi.getter
    def rename(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicate if it should rename the branch rather than use an existing branch. Defaults to `false`.
        """
        return pulumi.get(self, "rename")
