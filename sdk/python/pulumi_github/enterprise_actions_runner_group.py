...
class EnterpriseActionsRunnerGroupArgs:
    def __init__(__self__, *,
                 ...
                 selected_organization_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = None,
        ...
        :param pulumi.Input[_builtins.bool] restricted_to_workflows: If true, the runner group will be restricted to running only the workflows specified in the selected_workflows array. Defaults to false.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] selected_organization_ids: IDs of the organizations which should be added to the runner group
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] selected_workflows: List of workflows the runner group should be allowed to run. This setting will be ignored unless restricted_to_workflows is set to true.
        """
    ...
    def selected_organization_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]:
        """
    ...
    def selected_organization_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]):
...
class _EnterpriseActionsRunnerGroupState:
    def __init__(__self__, *,
                 ...
                 selected_organization_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 selected_organizations_url: Optional[pulumi.Input[_builtins.str]] = None,
                 selected_workflows: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the runner group
        :param pulumi.Input[_builtins.bool] restricted_to_workflows: If true, the runner group will be restricted to running only the workflows specified in the selected_workflows array. Defaults to false.
        :param pulumi.Input[_builtins.str] runners_url: The GitHub API URL for the runner group's runners
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] selected_organization_ids: IDs of the organizations which should be added to the runner group
        :param pulumi.Input[_builtins.str] selected_organizations_url: The GitHub API URL for the runner group's selected organizations
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] selected_workflows: List of workflows the runner group should be allowed to run. This setting will be ignored unless restricted_to_workflows is set to true.
        :param pulumi.Input[_builtins.str] visibility: Visibility of a runner group to enterprise organizations. Whether the runner group can include `all` or `selected`
        """
        if allows_public_repositories is not None:
    ...
    def selected_organizations_url(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def selected_organizations_url(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class EnterpriseActionsRunnerGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            selected_organizations_url: Optional[pulumi.Input[_builtins.str]] = None,
            selected_workflows: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnterpriseActionsRunnerGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="allowsPublicRepositories")
    def allows_public_repositories(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether public repositories can be added to the runner group. Defaults to false.
        """
        return pulumi.get(self, "allows_public_repositories")
    ...
    @_builtins.property
    @pulumi.getter(name="restrictedToWorkflows")
    def restricted_to_workflows(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, the runner group will be restricted to running only the workflows specified in the selected_workflows array. Defaults to false.
        """
        return pulumi.get(self, "restricted_to_workflows")
    ...
    @_builtins.property
    @pulumi.getter(name="runnersUrl")
    def runners_url(self) -> pulumi.Output[_builtins.str]:
        """
        The GitHub API URL for the runner group's runners
        """
        return pulumi.get(self, "runners_url")
    ...
    @_builtins.property
    @pulumi.getter(name="selectedOrganizationIds")
    def selected_organization_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.int]]]:
        """
        IDs of the organizations which should be added to the runner group
        """
        return pulumi.get(self, "selected_organization_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="selectedOrganizationsUrl")
    def selected_organizations_url(self) -> pulumi.Output[_builtins.str]:
        """
        The GitHub API URL for the runner group's selected organizations
        """
        return pulumi.get(self, "selected_organizations_url")
    ...
    @_builtins.property
    @pulumi.getter(name="selectedWorkflows")
    def selected_workflows(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of workflows the runner group should be allowed to run. This setting will be ignored unless restricted_to_workflows is set to true.
        """
        return pulumi.get(self, "selected_workflows")
