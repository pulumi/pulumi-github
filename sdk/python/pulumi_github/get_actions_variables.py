...
def get_actions_variables(full_name: Optional[builtins.str] = None,
...
def get_actions_variables_output(full_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
