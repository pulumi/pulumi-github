...
class GetOrganizationResult:
    ...
    def advanced_security_enabled_for_new_repositories(self) -> builtins.bool:
        """
    ...
    def dependabot_alerts_enabled_for_new_repositories(self) -> builtins.bool:
        """
    ...
    def dependabot_security_updates_enabled_for_new_repositories(self) -> builtins.bool:
        """
    ...
    def dependency_graph_enabled_for_new_repositories(self) -> builtins.bool:
        """
    ...
    def ignore_archived_repos(self) -> Optional[builtins.bool]:
    ...
    def members_can_create_internal_repositories(self) -> builtins.bool:
        """
    ...
    def members_can_create_pages(self) -> builtins.bool:
        """
    ...
    def members_can_create_private_pages(self) -> builtins.bool:
        """
    ...
    def members_can_create_private_repositories(self) -> builtins.bool:
        """
    ...
    def members_can_create_public_pages(self) -> builtins.bool:
        """
    ...
    def members_can_create_public_repositories(self) -> builtins.bool:
        """
    ...
    def members_can_create_repositories(self) -> builtins.bool:
        """
    ...
    def members_can_fork_private_repositories(self) -> builtins.bool:
        """
    ...
    def secret_scanning_enabled_for_new_repositories(self) -> builtins.bool:
        """
    ...
    def secret_scanning_push_protection_enabled_for_new_repositories(self) -> builtins.bool:
        """
    ...
    def two_factor_requirement_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Sequence[Mapping[str, builtins.str]]:
        """
    ...
    def web_commit_signoff_required(self) -> builtins.bool:
        """
...
def get_organization(ignore_archived_repos: Optional[builtins.bool] = None,
    ...
    :param builtins.bool ignore_archived_repos: Whether or not to include archived repos in the `repositories` list. Defaults to `false`.
    :param builtins.str name: The name of the organization.
    :param builtins.bool summary_only: Exclude the repos, members and other attributes from the returned result. Defaults to `false`.
    """
    __args__ = dict()
...
def get_organization_output(ignore_archived_repos: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
