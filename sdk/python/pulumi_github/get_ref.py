...
def get_ref(owner: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ref: The repository ref to look up. Must be formatted `heads/<ref>` for branches, and `tags/<ref>` for tags.
...
def get_ref_output(owner: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
