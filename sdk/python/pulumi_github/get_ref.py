...
def get_ref(owner: Optional[builtins.str] = None,
    ...
    :param builtins.str ref: The repository ref to look up. Must be formatted `heads/<ref>` for branches, and `tags/<ref>` for tags.
    :param builtins.str repository: The GitHub repository name.
    """
    __args__ = dict()
...
def get_ref_output(owner: Optional[pulumi.Input[Optional[builtins.str]]] = None,
