...
class GetTreeResult:
    ...
    def tree_sha(self) -> _builtins.str:
...
def get_tree(recursive: Optional[_builtins.bool] = None,
             repository: Optional[_builtins.str] = None,
             tree_sha: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool recursive: Setting this parameter to `true` returns the objects or subtrees referenced by the tree specified in `tree_sha`.
    :param _builtins.str repository: The name of the repository.
    :param _builtins.str tree_sha: The SHA1 value for the tree.
    """
    __args__ = dict()
