...
class DependabotOrganizationSecretArgs:
    def __init__(__self__, *,
                 ...
                 encrypted_value: Optional[pulumi.Input[builtins.str]] = None,
                 plaintext_value: Optional[pulumi.Input[builtins.str]] = None,
                 selected_repository_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] visibility: Configures the access that repositories have to the organization secret.
               Must be one of `all`, `private`, `selected`. `selected_repository_ids` is required if set to `selected`.
        :param pulumi.Input[builtins.str] encrypted_value: Encrypted value of the secret using the GitHub public key in Base64 format.
        :param pulumi.Input[builtins.str] plaintext_value: Plaintext value of the secret to be encrypted
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] selected_repository_ids: An array of repository ids that can access the organization secret.
        """
    ...
    def encrypted_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encrypted_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encrypted_value", value)

    @property
    @pulumi.getter(name="plaintextValue")
    def plaintext_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plaintext_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plaintext_value", value)

    @property
    @pulumi.getter(name="selectedRepositoryIds")
    def selected_repository_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    def selected_repository_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
class _DependabotOrganizationSecretState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Date of dependabot_secret creation.
        :param pulumi.Input[builtins.str] encrypted_value: Encrypted value of the secret using the GitHub public key in Base64 format.
        :param pulumi.Input[builtins.str] plaintext_value: Plaintext value of the secret to be encrypted
        :param pulumi.Input[builtins.str] secret_name: Name of the secret
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] selected_repository_ids: An array of repository ids that can access the organization secret.
        :param pulumi.Input[builtins.str] updated_at: Date of dependabot_secret update.
        :param pulumi.Input[builtins.str] visibility: Configures the access that repositories have to the organization secret.
               Must be one of `all`, `private`, `selected`. `selected_repository_ids` is required if set to `selected`.
        """
...
class DependabotOrganizationSecret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            selected_repository_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            visibility: Optional[pulumi.Input[builtins.str]] = None) -> 'DependabotOrganizationSecret':
        """
    ...
    @property
    @pulumi.getter(name="encryptedValue")
    def encrypted_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Encrypted value of the secret using the GitHub public key in Base64 format.
        """
        return pulumi.get(self, "encrypted_value")
    ...
    @property
    @pulumi.getter(name="plaintextValue")
    def plaintext_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Plaintext value of the secret to be encrypted
        """
        return pulumi.get(self, "plaintext_value")
    ...
    @property
    @pulumi.getter(name="selectedRepositoryIds")
    def selected_repository_ids(self) -> pulumi.Output[Optional[Sequence[builtins.int]]]:
        """
        An array of repository ids that can access the organization secret.
        """
        return pulumi.get(self, "selected_repository_ids")
