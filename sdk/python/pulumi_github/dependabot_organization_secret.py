...
class DependabotOrganizationSecret(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_allow_drift = github.DependabotOrganizationSecret("example_allow_drift",
            secret_name="example_secret_name",
            visibility="all",
    ...
    def get(resource_name: str,
            ...
            value: pulumi.Input[Optional[_builtins.str]] = None,
            value_encrypted: pulumi.Input[Optional[_builtins.str]] = None,
            visibility: pulumi.Input[Optional[_builtins.str]] = None) -> 'DependabotOrganizationSecret':
        """
