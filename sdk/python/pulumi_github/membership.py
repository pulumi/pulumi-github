...
class MembershipArgs:
    def __init__(__self__, *,
                 ...
                 downgrade_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Membership resource.
        :param pulumi.Input[builtins.str] username: The user to add to the organization.
        :param pulumi.Input[builtins.bool] downgrade_on_destroy: Defaults to `false`. If set to true,
        ...
        :param pulumi.Input[builtins.str] role: The role of the user within the organization.
    ...
    def downgrade_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def downgrade_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Membership(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Membership':
        """
    ...
    @property
    @pulumi.getter(name="downgradeOnDestroy")
    def downgrade_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`. If set to true,
        when this resource is destroyed, the member will not be removed
        from the organization. Instead, the member's role will be
