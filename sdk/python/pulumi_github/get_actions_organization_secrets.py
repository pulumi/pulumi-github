...
def get_actions_organization_secrets_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetActionsOrganizationSecretsResult]:
    """
    Use this data source to retrieve the list of secrets of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('github:index/getActionsOrganizationSecrets:getActionsOrganizationSecrets', __args__, opts=opts, typ=GetActionsOrganizationSecretsResult)
    return __ret__.apply(lambda __response__: GetActionsOrganizationSecretsResult(
