...
class RepositoryCollaboratorArgs:
    def __init__(__self__, *,
                 ...
                 permission_diff_suppression: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] permission: The permission of the outside collaborator for the repository.
               Must be one of `pull`, `push`, `maintain`, `triage` or `admin` or the name of an existing [custom repository role](https://docs.github.com/en/enterprise-cloud@latest/organizations/managing-peoples-access-to-your-organization-with-roles/managing-custom-repository-roles-for-an-organization) within the organization for organization-owned repositories.
               Must be `push` for personal repositories. Defaults to `push`.
        :param pulumi.Input[builtins.bool] permission_diff_suppression: Suppress plan diffs for `triage` and `maintain`.  Defaults to `false`.
        """
    ...
    def permission_diff_suppression(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def permission_diff_suppression(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RepositoryCollaboratorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] invitation_id: ID of the invitation to be used in `UserInvitationAccepter`
        :param pulumi.Input[builtins.str] permission: The permission of the outside collaborator for the repository.
               Must be one of `pull`, `push`, `maintain`, `triage` or `admin` or the name of an existing [custom repository role](https://docs.github.com/en/enterprise-cloud@latest/organizations/managing-peoples-access-to-your-organization-with-roles/managing-custom-repository-roles-for-an-organization) within the organization for organization-owned repositories.
               Must be `push` for personal repositories. Defaults to `push`.
        :param pulumi.Input[builtins.bool] permission_diff_suppression: Suppress plan diffs for `triage` and `maintain`.  Defaults to `false`.
...
class RepositoryCollaborator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            permission_diff_suppression: Optional[pulumi.Input[builtins.bool]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryCollaborator':
        """
    ...
    @property
    @pulumi.getter(name="permissionDiffSuppression")
    def permission_diff_suppression(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Suppress plan diffs for `triage` and `maintain`.  Defaults to `false`.
        """
        return pulumi.get(self, "permission_diff_suppression")
