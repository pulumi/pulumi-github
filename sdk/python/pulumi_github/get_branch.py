...
def get_branch(branch: Optional[builtins.str] = None,
    ...
    :param builtins.str branch: The repository branch to retrieve.
...
def get_branch_output(branch: Optional[pulumi.Input[builtins.str]] = None,
