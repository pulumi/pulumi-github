...
def get_dependabot_secrets(full_name: Optional[_builtins.str] = None,
...
def get_dependabot_secrets_output(full_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
