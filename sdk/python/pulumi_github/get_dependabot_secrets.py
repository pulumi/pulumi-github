...
def get_dependabot_secrets(full_name: Optional[builtins.str] = None,
...
def get_dependabot_secrets_output(full_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
