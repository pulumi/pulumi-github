...
__all__ = [
    ...
    'AwaitableGetCodespacesOrganizationPublicKeyResult',
    'get_codespaces_organization_public_key',
    'get_codespaces_organization_public_key_output',
]

@pulumi.output_type
class GetCodespacesOrganizationPublicKeyResult:
    """
...
class AwaitableGetCodespacesOrganizationPublicKeyResult(GetCodespacesOrganizationPublicKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCodespacesOrganizationPublicKeyResult(
            id=self.id,
            key=self.key,
            key_id=self.key_id)
...
def get_codespaces_organization_public_key_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCodespacesOrganizationPublicKeyResult]:
    """
    Use this data source to retrieve information about a GitHub Codespaces Organization public key. This data source is required to be used with other GitHub secrets interactions.
    Note that the provider `token` must have admin rights to an organization to retrieve it's Codespaces public key.
    ...
    __ret__ = pulumi.runtime.invoke_output('github:index/getCodespacesOrganizationPublicKey:getCodespacesOrganizationPublicKey', __args__, opts=opts, typ=GetCodespacesOrganizationPublicKeyResult)
    return __ret__.apply(lambda __response__: GetCodespacesOrganizationPublicKeyResult(
