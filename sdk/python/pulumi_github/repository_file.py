...
class RepositoryFileArgs:
    def __init__(__self__, *,
                 ...
                 autocreate_branch: Optional[pulumi.Input[builtins.bool]] = None,
                 autocreate_branch_source_branch: Optional[pulumi.Input[builtins.str]] = None,
                 autocreate_branch_source_sha: Optional[pulumi.Input[builtins.str]] = None,
                 branch: Optional[pulumi.Input[builtins.str]] = None,
                 commit_author: Optional[pulumi.Input[builtins.str]] = None,
                 commit_email: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] repository: The repository to create the file in.
        :param pulumi.Input[builtins.bool] autocreate_branch: Automatically create the branch if it could not be found. Defaults to false. Subsequent reads if the branch is deleted will occur from 'autocreate_branch_source_branch'.
        :param pulumi.Input[builtins.str] autocreate_branch_source_branch: The branch name to start from, if 'autocreate_branch' is set. Defaults to 'main'.
        :param pulumi.Input[builtins.str] autocreate_branch_source_sha: The commit hash to start from, if 'autocreate_branch' is set. Defaults to the tip of 'autocreate_branch_source_branch'. If provided, 'autocreate_branch_source_branch' is ignored.
        :param pulumi.Input[builtins.str] branch: Git branch (defaults to the repository's default branch).
               The branch must already exist, it will only be created automatically if 'autocreate_branch' is set true.
        :param pulumi.Input[builtins.str] commit_author: Committer author name to use. **NOTE:** GitHub app users may omit author and email information so GitHub can verify commits as the GitHub App. This maybe useful when a branch protection rule requires signed commits.
        :param pulumi.Input[builtins.str] commit_email: Committer email address to use. **NOTE:** GitHub app users may omit author and email information so GitHub can verify commits as the GitHub App. This may be useful when a branch protection rule requires signed commits.
        :param pulumi.Input[builtins.str] commit_message: The commit message when creating, updating or deleting the managed file.
        :param pulumi.Input[builtins.bool] overwrite_on_create: Enable overwriting existing files. If set to `true` it will overwrite an existing file with the same name. If set to `false` it will fail if there is an existing file with the same name.
        """
    ...
    def autocreate_branch(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def autocreate_branch(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "autocreate_branch", value)

    @property
    @pulumi.getter(name="autocreateBranchSourceBranch")
    def autocreate_branch_source_branch(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def autocreate_branch_source_branch(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "autocreate_branch_source_branch", value)

    @property
    @pulumi.getter(name="autocreateBranchSourceSha")
    def autocreate_branch_source_sha(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def autocreate_branch_source_sha(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def commit_author(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def commit_author(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "commit_author", value)

    @property
    @pulumi.getter(name="commitEmail")
    def commit_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @commit_email.setter
    def commit_email(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RepositoryFileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] commit_email: Committer email address to use. **NOTE:** GitHub app users may omit author and email information so GitHub can verify commits as the GitHub App. This may be useful when a branch protection rule requires signed commits.
        :param pulumi.Input[builtins.str] commit_message: The commit message when creating, updating or deleting the managed file.
        :param pulumi.Input[builtins.str] commit_sha: The SHA of the commit that modified the file.
        :param pulumi.Input[builtins.str] content: The file content.
        :param pulumi.Input[builtins.str] file: The path of the file to manage.
        :param pulumi.Input[builtins.bool] overwrite_on_create: Enable overwriting existing files. If set to `true` it will overwrite an existing file with the same name. If set to `false` it will fail if there is an existing file with the same name.
        :param pulumi.Input[builtins.str] ref: The name of the commit/branch/tag.
        :param pulumi.Input[builtins.str] repository: The repository to create the file in.
        :param pulumi.Input[builtins.str] sha: The SHA blob of the file.
        """
        if autocreate_branch is not None:
            pulumi.set(__self__, "autocreate_branch", autocreate_branch)
        if autocreate_branch_source_branch is not None:
...
class RepositoryFile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ref: Optional[pulumi.Input[builtins.str]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None,
            sha: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryFile':
        """
    ...
    @property
    @pulumi.getter(name="autocreateBranch")
    def autocreate_branch(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Automatically create the branch if it could not be found. Defaults to false. Subsequent reads if the branch is deleted will occur from 'autocreate_branch_source_branch'.
        """
        return pulumi.get(self, "autocreate_branch")
    ...
    @property
    @pulumi.getter(name="autocreateBranchSourceBranch")
    def autocreate_branch_source_branch(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The branch name to start from, if 'autocreate_branch' is set. Defaults to 'main'.
        """
        return pulumi.get(self, "autocreate_branch_source_branch")
    ...
    @property
    @pulumi.getter(name="autocreateBranchSourceSha")
    def autocreate_branch_source_sha(self) -> pulumi.Output[builtins.str]:
        """
        The commit hash to start from, if 'autocreate_branch' is set. Defaults to the tip of 'autocreate_branch_source_branch'. If provided, 'autocreate_branch_source_branch' is ignored.
        """
        return pulumi.get(self, "autocreate_branch_source_sha")
    ...
    @property
    @pulumi.getter(name="commitAuthor")
    def commit_author(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Committer author name to use. **NOTE:** GitHub app users may omit author and email information so GitHub can verify commits as the GitHub App. This maybe useful when a branch protection rule requires signed commits.
        """
        return pulumi.get(self, "commit_author")
    ...
    @property
    @pulumi.getter(name="commitEmail")
    def commit_email(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Committer email address to use. **NOTE:** GitHub app users may omit author and email information so GitHub can verify commits as the GitHub App. This may be useful when a branch protection rule requires signed commits.
        """
        return pulumi.get(self, "commit_email")
    ...
    @property
    @pulumi.getter(name="commitSha")
    def commit_sha(self) -> pulumi.Output[builtins.str]:
        """
        The SHA of the commit that modified the file.
        """
        return pulumi.get(self, "commit_sha")
