...
def get_repository_autolink_references(repository: Optional[builtins.str] = None,
    ...
    :param builtins.str repository: Name of the repository to retrieve the autolink references from.
    """
    __args__ = dict()
...
def get_repository_autolink_references_output(repository: Optional[pulumi.Input[builtins.str]] = None,
