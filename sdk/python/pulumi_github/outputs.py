...
class ActionsOrganizationPermissionsAllowedActionsConfig(dict):
    ...
    def __init__(__self__, *,
                 github_owned_allowed: builtins.bool,
                 patterns_alloweds: Optional[Sequence[builtins.str]] = None,
                 verified_allowed: Optional[builtins.bool] = None):
        """
        :param builtins.bool github_owned_allowed: Whether GitHub-owned actions are allowed in the organization.
        :param Sequence[builtins.str] patterns_alloweds: Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, monalisa/octocat@*, monalisa/octocat@v2, monalisa/*."
        :param builtins.bool verified_allowed: Whether actions in GitHub Marketplace from verified creators are allowed. Set to true to allow all GitHub Marketplace actions by verified creators.
        """
    ...
    def github_owned_allowed(self) -> builtins.bool:
        """
    ...
    def patterns_alloweds(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def verified_allowed(self) -> Optional[builtins.bool]:
        """
...
class ActionsOrganizationPermissionsEnabledRepositoriesConfig(dict):
    ...
    def __init__(__self__, *,
                 repository_ids: Sequence[builtins.int]):
        """
        :param Sequence[builtins.int] repository_ids: List of repository IDs to enable for GitHub Actions.
        """
        pulumi.set(__self__, "repository_ids", repository_ids)

    @property
    @pulumi.getter(name="repositoryIds")
    def repository_ids(self) -> Sequence[builtins.int]:
        """
...
class ActionsRepositoryPermissionsAllowedActionsConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 verified_allowed: Optional[builtins.bool] = None):
        """
        :param builtins.bool github_owned_allowed: Whether GitHub-owned actions are allowed in the repository.
        :param Sequence[builtins.str] patterns_alloweds: Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, monalisa/octocat@*, monalisa/octocat@v2, monalisa/*."
        :param builtins.bool verified_allowed: Whether actions in GitHub Marketplace from verified creators are allowed. Set to true to allow all GitHub Marketplace actions by verified creators.
        """
        pulumi.set(__self__, "github_owned_allowed", github_owned_allowed)
...
class BranchProtectionRequiredPullRequestReview(dict):
    ...
    def __init__(__self__, *,
                 dismiss_stale_reviews: Optional[builtins.bool] = None,
                 dismissal_restrictions: Optional[Sequence[builtins.str]] = None,
                 pull_request_bypassers: Optional[Sequence[builtins.str]] = None,
                 require_code_owner_reviews: Optional[builtins.bool] = None,
                 require_last_push_approval: Optional[builtins.bool] = None,
                 required_approving_review_count: Optional[builtins.int] = None,
                 restrict_dismissals: Optional[builtins.bool] = None):
        """
        :param builtins.bool dismiss_stale_reviews: Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        :param Sequence[builtins.str] dismissal_restrictions: The list of actor Names/IDs with dismissal access. If not empty, `restrict_dismissals` is ignored. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams.
        :param Sequence[builtins.str] pull_request_bypassers: The list of actor Names/IDs that are allowed to bypass pull request requirements. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams.
        :param builtins.bool require_code_owner_reviews: Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        :param builtins.bool require_last_push_approval: Require that The most recent push must be approved by someone other than the last pusher.  Defaults to `false`
        :param builtins.int required_approving_review_count: Require x number of approvals to satisfy branch protection requirements. If this is specified it must be a number between 0-6. This requirement matches GitHub's API, see the upstream [documentation](https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
               (https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
        :param builtins.bool restrict_dismissals: Restrict pull request review dismissals.
        """
    ...
    def dismiss_stale_reviews(self) -> Optional[builtins.bool]:
        """
    ...
    def dismissal_restrictions(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def pull_request_bypassers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def require_code_owner_reviews(self) -> Optional[builtins.bool]:
        """
    ...
    def require_last_push_approval(self) -> Optional[builtins.bool]:
        """
    ...
    def required_approving_review_count(self) -> Optional[builtins.int]:
        """
    ...
    def restrict_dismissals(self) -> Optional[builtins.bool]:
        """
...
class BranchProtectionRequiredStatusCheck(dict):
    def __init__(__self__, *,
                 contexts: Optional[Sequence[builtins.str]] = None,
                 strict: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] contexts: The list of status checks to require in order to merge into this branch. No status checks are required by default.
        ...
        :param builtins.bool strict: Require branches to be up to date before merging. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter
    def contexts(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def strict(self) -> Optional[builtins.bool]:
        """
...
class BranchProtectionRestrictPush(dict):
    ...
    def __init__(__self__, *,
                 blocks_creations: Optional[builtins.bool] = None,
                 push_allowances: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool blocks_creations: Boolean, setting this to `false` allows people, teams, or apps to create new branches matching this rule. Defaults to `true`.
        :param Sequence[builtins.str] push_allowances: A list of actor Names/IDs that may push to the branch. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams. Organization administrators, repository administrators, and users with the Maintain role on the repository can always push when all other requirements have passed.
        """
    ...
    def blocks_creations(self) -> Optional[builtins.bool]:
        """
    ...
    def push_allowances(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BranchProtectionV3RequiredPullRequestReviews(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dismiss_stale_reviews: Optional[builtins.bool] = None,
                 dismissal_apps: Optional[Sequence[builtins.str]] = None,
                 dismissal_teams: Optional[Sequence[builtins.str]] = None,
                 dismissal_users: Optional[Sequence[builtins.str]] = None,
                 include_admins: Optional[builtins.bool] = None,
                 require_code_owner_reviews: Optional[builtins.bool] = None,
                 require_last_push_approval: Optional[builtins.bool] = None,
                 required_approving_review_count: Optional[builtins.int] = None):
        """
        ...
        :param builtins.bool dismiss_stale_reviews: Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        :param Sequence[builtins.str] dismissal_apps: The list of app slugs with dismissal access.
        :param Sequence[builtins.str] dismissal_teams: The list of team slugs with dismissal access.
               Always use `slug` of the team, **not** its name. Each team already **has** to have access to the repository.
        :param Sequence[builtins.str] dismissal_users: The list of user logins with dismissal access
        :param builtins.bool require_code_owner_reviews: Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        :param builtins.bool require_last_push_approval: Require that the most recent push must be approved by someone other than the last pusher.  Defaults to `false`
        :param builtins.int required_approving_review_count: Require x number of approvals to satisfy branch protection requirements. If this is specified it must be a number between 0-6. This requirement matches GitHub's API, see the upstream [documentation](https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
        """
    ...
    def dismissal_apps(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def dismissal_teams(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def dismissal_users(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def include_admins(self) -> Optional[builtins.bool]:
...
class BranchProtectionV3RequiredPullRequestReviewsBypassPullRequestAllowances(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] apps: The list of app slugs allowed to bypass pull request requirements.
        :param Sequence[builtins.str] teams: The list of team slugs allowed to bypass pull request requirements.
        :param Sequence[builtins.str] users: The list of user logins allowed to bypass pull request requirements.
        """
        if apps is not None:
...
class BranchProtectionV3RequiredStatusChecks(dict):
    ...
    def __init__(__self__, *,
                 checks: Optional[Sequence[builtins.str]] = None,
                 contexts: Optional[Sequence[builtins.str]] = None,
                 include_admins: Optional[builtins.bool] = None,
                 strict: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] checks: The list of status checks to require in order to merge into this branch. No status checks are required by default. Checks should be strings containing the context and app_id like so "context:app_id".
        :param Sequence[builtins.str] contexts: [**DEPRECATED**] (Optional) The list of status checks to require in order to merge into this branch. No status checks are required by default.
    ...
    @property
    @pulumi.getter
    def checks(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BranchProtectionV3Restrictions(dict):
    def __init__(__self__, *,
                 ...
                 users: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] apps: The list of app slugs with push access.
               
               `restrictions` is only available for organization-owned repositories.
        :param Sequence[builtins.str] teams: The list of team slugs with push access.
               Always use `slug` of the team, **not** its name. Each team already **has** to have access to the repository.
        :param Sequence[builtins.str] users: The list of user logins with push access.
        """
        if apps is not None:
            pulumi.set(__self__, "apps", apps)
        if teams is not None:
...
class EnterpriseActionsPermissionsEnabledOrganizationsConfig(dict):
    ...
    def __init__(__self__, *,
                 organization_ids: Sequence[builtins.int]):
        """
        :param Sequence[builtins.int] organization_ids: List of organization IDs to enable for GitHub Actions.
        """
        pulumi.set(__self__, "organization_ids", organization_ids)

    @property
    @pulumi.getter(name="organizationIds")
    def organization_ids(self) -> Sequence[builtins.int]:
        """
...
class IssueLabelsLabel(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str color: A 6 character hex code, **without the leading #**, identifying the color of the label.
        :param builtins.str name: The name of the label.
        :param builtins.str description: A short description of the label.
        :param builtins.str url: The URL to the issue label
        """
...
class OrganizationRulesetBypassActor(dict):
    ...
    def __init__(__self__, *,
                 actor_id: builtins.int,
                 actor_type: builtins.str,
                 bypass_mode: builtins.str):
        """
        :param builtins.int actor_id: (Number) The ID of the actor that can bypass a ruleset.
        :param builtins.str actor_type: The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`.
        :param builtins.str bypass_mode: (String) When the specified actor can bypass the ruleset. pull_request means that an actor can only bypass rules on pull requests. Can be one of: `always`, `pull_request`.
    ...
    def actor_id(self) -> builtins.int:
        """
...
class OrganizationRulesetConditions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 repository_ids: Optional[Sequence[builtins.int]] = None,
        ...
        :param Sequence[builtins.int] repository_ids: The repository IDs that the ruleset applies to. One of these IDs must match for the condition to pass. Conflicts with `repository_name`.
    ...
    @property
    @pulumi.getter(name="repositoryIds")
    def repository_ids(self) -> Optional[Sequence[builtins.int]]:
        """
...
class OrganizationRulesetConditionsRefName(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] excludes: Array of ref names or patterns to exclude. The condition will not pass if any of these patterns match.
        :param Sequence[builtins.str] includes: Array of ref names or patterns to include. One of these patterns must match for the condition to pass. Also accepts `~DEFAULT_BRANCH` to include the default branch or `~ALL` to include all branches.
        """
...
class OrganizationRulesetConditionsRepositoryName(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] excludes: Array of repository names or patterns to exclude. The condition will not pass if any of these patterns match.
        :param Sequence[builtins.str] includes: Array of repository names or patterns to include. One of these patterns must match for the condition to pass. Also accepts `~ALL` to include all repositories.
        :param builtins.bool protected: Whether renaming of target repositories is prevented.
        """
        pulumi.set(__self__, "excludes", excludes)
        pulumi.set(__self__, "includes", includes)
...
class OrganizationRulesetRules(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "requiredCodeScanning":
            suggest = "required_code_scanning"
    ...
    def __init__(__self__, *,
                 ...
                 creation: Optional[builtins.bool] = None,
                 deletion: Optional[builtins.bool] = None,
                 non_fast_forward: Optional[builtins.bool] = None,
                 ...
                 required_linear_history: Optional[builtins.bool] = None,
                 required_signatures: Optional[builtins.bool] = None,
        ...
        :param builtins.bool creation: (Boolean) Only allow users with bypass permission to create matching refs.
        :param builtins.bool deletion: (Boolean) Only allow users with bypass permissions to delete matching refs.
        :param builtins.bool non_fast_forward: (Boolean) Prevent users with push access from force pushing to branches.
        ...
        :param builtins.bool required_linear_history: (Boolean) Prevent merge commits from being pushed to matching branches.
        :param builtins.bool required_signatures: (Boolean) Commits pushed to matching branches must have verified signatures.
        ...
        :param builtins.bool update: (Boolean) Only allow users with bypass permission to update matching refs.
        """
    ...
    @property
    @pulumi.getter
    def creation(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def deletion(self) -> Optional[builtins.bool]:
        """
    ...
    def non_fast_forward(self) -> Optional[builtins.bool]:
        """
    ...
    def required_code_scanning(self) -> Optional['outputs.OrganizationRulesetRulesRequiredCodeScanning']:
        """
    ...
    def required_linear_history(self) -> Optional[builtins.bool]:
        """
    ...
    def required_signatures(self) -> Optional[builtins.bool]:
        """
...
class OrganizationRulesetRulesBranchNamePattern(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: The operator to use for matching. Can be one of: `starts_with`, `ends_with`, `contains`, `regex`.
        :param builtins.str pattern: The pattern to match with.
        :param builtins.str name: (String) The name of the ruleset.
        :param builtins.bool negate: If true, the rule will fail if the pattern matches.
        """
...
class OrganizationRulesetRulesPullRequest(dict):
    ...
    def __init__(__self__, *,
                 dismiss_stale_reviews_on_push: Optional[builtins.bool] = None,
                 require_code_owner_review: Optional[builtins.bool] = None,
                 require_last_push_approval: Optional[builtins.bool] = None,
                 required_approving_review_count: Optional[builtins.int] = None,
                 required_review_thread_resolution: Optional[builtins.bool] = None):
        """
        :param builtins.bool dismiss_stale_reviews_on_push: New, reviewable commits pushed will dismiss previous pull request review approvals. Defaults to `false`.
        :param builtins.bool require_code_owner_review: Require an approving review in pull requests that modify files that have a designated code owner. Defaults to `false`.
        :param builtins.bool require_last_push_approval: Whether the most recent reviewable push must be approved by someone other than the person who pushed it. Defaults to `false`.
        :param builtins.int required_approving_review_count: The number of approving reviews that are required before a pull request can be merged. Defaults to `0`.
        :param builtins.bool required_review_thread_resolution: All conversations on code must be resolved before a pull request can be merged. Defaults to `false`.
        """
    ...
    def dismiss_stale_reviews_on_push(self) -> Optional[builtins.bool]:
        """
    ...
    def require_code_owner_review(self) -> Optional[builtins.bool]:
        """
    ...
    def required_review_thread_resolution(self) -> Optional[builtins.bool]:
        """
...
class OrganizationRulesetRulesRequiredCodeScanning(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "requiredCodeScanningTools":
            suggest = "required_code_scanning_tools"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in OrganizationRulesetRulesRequiredCodeScanning. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        OrganizationRulesetRulesRequiredCodeScanning.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 required_code_scanning_tools: Sequence['outputs.OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningTool']):
        """
        :param Sequence['OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningToolArgs'] required_code_scanning_tools: Tools that must provide code scanning results for this rule to pass.
        """
    ...
    def required_code_scanning_tools(self) -> Sequence['outputs.OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningTool']:
        """
...
@pulumi.output_type
class OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningTool(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "alertsThreshold":
            suggest = "alerts_threshold"
        elif key == "securityAlertsThreshold":
            suggest = "security_alerts_threshold"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningTool. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningTool.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 tool: builtins.str):
        """
        :param builtins.str alerts_threshold: The severity level at which code scanning results that raise alerts block a reference update. Can be one of: `none`, `errors`, `errors_and_warnings`, `all`.
        :param builtins.str security_alerts_threshold: The severity level at which code scanning results that raise security alerts block a reference update. Can be one of: `none`, `critical`, `high_or_higher`, `medium_or_higher`, `all`.
        :param builtins.str tool: The name of a code scanning tool.
        """
...
class OrganizationRulesetRulesRequiredStatusChecks(dict):
    ...
    def __init__(__self__, *,
                 ...
                 strict_required_status_checks_policy: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.bool strict_required_status_checks_policy: Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled. Defaults to `false`.
        """
    ...
    def strict_required_status_checks_policy(self) -> Optional[builtins.bool]:
        """
...
class OrganizationRulesetRulesRequiredStatusChecksRequiredCheck(dict):
    ...
    def __init__(__self__, *,
                 ...
                 integration_id: Optional[builtins.int] = None):
        """
        :param builtins.str context: The status check context name that must be present on the commit.
        :param builtins.int integration_id: The optional integration ID that this status check must originate from.
        """
    ...
    def integration_id(self) -> Optional[builtins.int]:
        """
...
class OrganizationRulesetRulesRequiredWorkflowsRequiredWorkflow(dict):
    ...
    def __init__(__self__, *,
                 path: builtins.str,
                 repository_id: builtins.int,
                 ref: Optional[builtins.str] = None):
        """
        :param builtins.str path: The path to the workflow YAML definition file.
        :param builtins.int repository_id: The repository in which the workflow is defined.
        :param builtins.str ref: The ref (branch or tag) of the workflow file to use.
        """
...
class OrganizationWebhookConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: URL of the webhook
        :param builtins.str content_type: The content type for the payload. Valid values are either 'form' or 'json'.
        :param builtins.bool insecure_ssl: Insecure SSL boolean toggle. Defaults to 'false'.
        :param builtins.str secret: The shared secret for the webhook
        """
        pulumi.set(__self__, "url", url)
...
class RepositoryCollaboratorsIgnoreTeam(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str team_id: ID or slug of the team to ignore.
        """
...
class RepositoryCollaboratorsTeam(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str team_id: The GitHub team id or the GitHub team slug.
        :param builtins.str permission: The permission of the outside collaborators for the repository.
...
class RepositoryCollaboratorsUser(dict):
    def __init__(__self__, *,
                 ...
                 permission: Optional[builtins.str] = None):
        """
        :param builtins.str username: The user to add to the repository as a collaborator.
        :param builtins.str permission: The permission of the outside collaborators for the repository.
...
class RepositoryEnvironmentDeploymentBranchPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool custom_branch_policies: Whether only branches that match the specified name patterns can deploy to this environment.
        :param builtins.bool protected_branches: Whether only branches with branch protection rules can deploy to this environment.
        """
...
class RepositoryEnvironmentReviewer(dict):
    def __init__(__self__, *,
                 teams: Optional[Sequence[builtins.int]] = None,
                 users: Optional[Sequence[builtins.int]] = None):
        """
        :param Sequence[builtins.int] teams: Up to 6 IDs for teams who may review jobs that reference the environment. Reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.
        :param Sequence[builtins.int] users: Up to 6 IDs for users who may review jobs that reference the environment. Reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.
        """
        if teams is not None:
            pulumi.set(__self__, "teams", teams)
        if users is not None:
    ...
    @property
    @pulumi.getter
    def teams(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Optional[Sequence[builtins.int]]:
        """
...
class RepositoryPages(dict):
    ...
    def __init__(__self__, *,
                 build_type: Optional[builtins.str] = None,
                 cname: Optional[builtins.str] = None,
                 custom404: Optional[builtins.bool] = None,
                 html_url: Optional[builtins.str] = None,
                 source: Optional['outputs.RepositoryPagesSource'] = None,
                 status: Optional[builtins.str] = None,
                 url: Optional[builtins.str] = None):
        """
        :param builtins.str build_type: The type of GitHub Pages site to build. Can be `legacy` or `workflow`. If you use `legacy` as build type you need to set the option `source`.
        :param builtins.str cname: The custom domain for the repository. This can only be set after the repository has been created.
        :param builtins.bool custom404: Whether the rendered GitHub Pages site has a custom 404 page.
        :param builtins.str html_url: The absolute URL (including scheme) of the rendered GitHub Pages site e.g. `https://username.github.io`.
        ...
        :param builtins.str status: The GitHub Pages site's build status e.g. `building` or `built`.
        """
    ...
    def build_type(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def custom404(self) -> Optional[builtins.bool]:
        """
    ...
    def html_url(self) -> Optional[builtins.str]:
        """
...
class RepositoryPagesSource(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str branch: The repository branch used to publish the site's source files. (i.e. `main` or `gh-pages`.
        :param builtins.str path: The repository directory from which the site publishes (Default: `/`).
        """
...
class RepositoryRulesetBypassActor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bypass_mode: builtins.str):
        """
        :param builtins.int actor_id: (Number) The ID of the actor that can bypass a ruleset. If `actor_type` is `Integration`, `actor_id` is a GitHub App ID. App ID can be obtained by following instructions from the [Get an App API docs](https://docs.github.com/en/rest/apps/apps?apiVersion=2022-11-28#get-an-app)
        :param builtins.str actor_type: The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`.
        :param builtins.str bypass_mode: (String) When the specified actor can bypass the ruleset. pull_request means that an actor can only bypass rules on pull requests. Can be one of: `always`, `pull_request`.
...
class RepositoryRulesetRules(dict):
    ...
    def __init__(__self__, *,
                 ...
                 update: Optional[builtins.bool] = None,
                 update_allows_fetch_and_merge: Optional[builtins.bool] = None):
        """
    ...
    @property
    @pulumi.getter(name="requiredCodeScanning")
    def required_code_scanning(self) -> Optional['outputs.RepositoryRulesetRulesRequiredCodeScanning']:
        """
        (Block List, Max: 1) Define which tools must provide code scanning results before the reference is updated. When configured, code scanning must be enabled and have results for both the commit and the reference being updated. Multiple code scanning tools can be specified. (see below for nested schema)
        """
        return pulumi.get(self, "required_code_scanning")
    ...
    def update_allows_fetch_and_merge(self) -> Optional[builtins.bool]:
        """
...
class RepositoryRulesetRulesMergeQueue(dict):
    ...
    def __init__(__self__, *,
                 check_response_timeout_minutes: Optional[builtins.int] = None,
                 grouping_strategy: Optional[builtins.str] = None,
                 max_entries_to_build: Optional[builtins.int] = None,
                 max_entries_to_merge: Optional[builtins.int] = None,
                 merge_method: Optional[builtins.str] = None,
                 min_entries_to_merge: Optional[builtins.int] = None,
                 min_entries_to_merge_wait_minutes: Optional[builtins.int] = None):
        """
        :param builtins.int check_response_timeout_minutes: Maximum time for a required status check to report a conclusion. After this much time has elapsed, checks that have not reported a conclusion will be assumed to have failed. Defaults to `60`.
        :param builtins.str grouping_strategy: When set to ALLGREEN, the merge commit created by merge queue for each PR in the group must pass all required checks to merge. When set to HEADGREEN, only the commit at the head of the merge group, i.e. the commit containing changes from all of the PRs in the group, must pass its required checks to merge. Can be one of: ALLGREEN, HEADGREEN. Defaults to `ALLGREEN`.
        :param builtins.int max_entries_to_build: Limit the number of queued pull requests requesting checks and workflow runs at the same time. Defaults to `5`.
        :param builtins.int max_entries_to_merge: The maximum number of PRs that will be merged together in a group. Defaults to `5`.
        :param builtins.str merge_method: Method to use when merging changes from queued pull requests. Can be one of: MERGE, SQUASH, REBASE. Defaults to `MERGE`.
        :param builtins.int min_entries_to_merge: The minimum number of PRs that will be merged together in a group. Defaults to `1`.
        :param builtins.int min_entries_to_merge_wait_minutes: The time merge queue should wait after the first PR is added to the queue for the minimum group size to be met. After this time has elapsed, the minimum group size will be ignored and a smaller group will be merged. Defaults to `5`.
        """
    ...
    def check_response_timeout_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def grouping_strategy(self) -> Optional[builtins.str]:
        """
    ...
    def max_entries_to_build(self) -> Optional[builtins.int]:
        """
    ...
    def max_entries_to_merge(self) -> Optional[builtins.int]:
        """
    ...
    def merge_method(self) -> Optional[builtins.str]:
        """
    ...
    def min_entries_to_merge(self) -> Optional[builtins.int]:
        """
    ...
    def min_entries_to_merge_wait_minutes(self) -> Optional[builtins.int]:
        """
...
class RepositoryRulesetRulesRequiredCodeScanning(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RepositoryRulesetRulesRequiredCodeScanning. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RepositoryRulesetRulesRequiredCodeScanning.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 required_code_scanning_tools: Sequence['outputs.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool']):
        """
        :param Sequence['RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningToolArgs'] required_code_scanning_tools: Tools that must provide code scanning results for this rule to pass.
        """
        pulumi.set(__self__, "required_code_scanning_tools", required_code_scanning_tools)

    @property
    @pulumi.getter(name="requiredCodeScanningTools")
    def required_code_scanning_tools(self) -> Sequence['outputs.RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool']:
        """
        Tools that must provide code scanning results for this rule to pass.
        """
        return pulumi.get(self, "required_code_scanning_tools")
...
@pulumi.output_type
class RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "alertsThreshold":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool.__key_warning(key)
        return super().__getitem__(key)
...
class RepositoryRulesetRulesRequiredDeployments(dict):
    ...
    def __init__(__self__, *,
                 required_deployment_environments: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] required_deployment_environments: The environments that must be successfully deployed to before branches can be merged.
        """
    ...
    def required_deployment_environments(self) -> Sequence[builtins.str]:
        """
...
class RepositoryRulesetRulesRequiredStatusChecks(dict):
    ...
    def __init__(__self__, *,
                 ...
                 do_not_enforce_on_create: Optional[builtins.bool] = None,
                 strict_required_status_checks_policy: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.bool do_not_enforce_on_create: Allow repositories and branches to be created if a check would otherwise prohibit it.
        :param builtins.bool strict_required_status_checks_policy: Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled. Defaults to `false`.
        """
        pulumi.set(__self__, "required_checks", required_checks)
    ...
    def do_not_enforce_on_create(self) -> Optional[builtins.bool]:
        """
...
class RepositorySecurityAndAnalysisAdvancedSecurity(dict):
    def __init__(__self__, *,
                 status: builtins.str):
        """
        :param builtins.str status: Set to `enabled` to enable advanced security features on the repository. Can be `enabled` or `disabled`.
        """
        pulumi.set(__self__, "status", status)
...
class RepositoryTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_all_branches: Optional[builtins.bool] = None):
        """
        :param builtins.str owner: The GitHub organization or user the template repository is owned by.
        :param builtins.str repository: The name of the template repository.
        :param builtins.bool include_all_branches: Whether the new repository should include all the branches from the template repository (defaults to false, which includes only the default branch from the template).
        """
    ...
    def include_all_branches(self) -> Optional[builtins.bool]:
        """
...
class RepositoryWebhookConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret: Optional[builtins.str] = None):
        """
        :param builtins.str url: The URL of the webhook.
        :param builtins.str content_type: The content type for the payload. Valid values are either `form` or `json`.
        :param builtins.bool insecure_ssl: Insecure SSL boolean toggle. Defaults to `false`.
        :param builtins.str secret: The shared secret for the webhook. [See API documentation](https://developer.github.com/v3/repos/hooks/#create-a-hook).
        """
        pulumi.set(__self__, "url", url)
        if content_type is not None:
            pulumi.set(__self__, "content_type", content_type)
...
class TeamMembersMember(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str username: The user to add to the team.
        :param builtins.str role: The role of the user within the team.
...
class TeamSettingsReviewRequestDelegation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 member_count: Optional[builtins.int] = None,
                 notify: Optional[builtins.bool] = None):
        """
        :param builtins.str algorithm: The algorithm to use when assigning pull requests to team members. Supported values are 'ROUND_ROBIN' and 'LOAD_BALANCE'.
        :param builtins.int member_count: The number of team members to assign to a pull request.
        :param builtins.bool notify: whether to notify the entire team when at least one member is also assigned to the pull request.
        """
    ...
    def member_count(self) -> Optional[builtins.int]:
        """
...
class TeamSyncGroupMappingGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_description: The description of the IdP group.
        :param builtins.str group_id: The ID of the IdP group.
        :param builtins.str group_name: The name of the IdP group.
        """
...
class GetActionsEnvironmentSecretsSecretResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str created_at: Timestamp of the secret creation
        :param builtins.str name: Name of the secret
        :param builtins.str updated_at: Timestamp of the secret last update
        """
...
class GetActionsEnvironmentVariablesVariableResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str created_at: Timestamp of the variable creation
        :param builtins.str name: Name of the variable
        :param builtins.str updated_at: Timestamp of the variable last update
...
class GetActionsOrganizationSecretsSecretResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str updated_at: Timestamp of the secret last update
        :param builtins.str visibility: Secret visibility
        """
        pulumi.set(__self__, "created_at", created_at)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "updated_at", updated_at)
...
class GetActionsOrganizationVariablesVariableResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str updated_at: Timestamp of the variable last update
        :param builtins.str value: Value of the variable
        :param builtins.str visibility: Visibility of the variable
        """
        pulumi.set(__self__, "created_at", created_at)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "updated_at", updated_at)
...
class GetBranchProtectionRulesRuleResult(dict):
    def __init__(__self__, *,
                 pattern: builtins.str):
        """
        :param builtins.str pattern: Identifies the protection rule pattern.
        """
        pulumi.set(__self__, "pattern", pattern)
...
class GetCollaboratorsCollaboratorResult(dict):
    def __init__(__self__, *,
                 events_url: builtins.str,
                 followers_url: builtins.str,
                 following_url: builtins.str,
                 gists_url: builtins.str,
                 html_url: builtins.str,
                 id: builtins.int,
                 login: builtins.str,
                 organizations_url: builtins.str,
                 permission: builtins.str,
                 received_events_url: builtins.str,
                 repos_url: builtins.str,
                 site_admin: builtins.bool,
                 starred_url: builtins.str,
                 subscriptions_url: builtins.str,
                 type: builtins.str,
                 url: builtins.str):
        """
        :param builtins.str events_url: The GitHub API URL for the collaborator's events.
        :param builtins.str followers_url: The GitHub API URL for the collaborator's followers.
        :param builtins.str following_url: The GitHub API URL for those following the collaborator.
        :param builtins.str gists_url: The GitHub API URL for the collaborator's gists.
        :param builtins.str html_url: The GitHub HTML URL for the collaborator.
        :param builtins.int id: The ID of the collaborator.
        :param builtins.str login: The collaborator's login.
        :param builtins.str organizations_url: The GitHub API URL for the collaborator's organizations.
        ...
        :param builtins.str received_events_url: The GitHub API URL for the collaborator's received events.
        :param builtins.str repos_url: The GitHub API URL for the collaborator's repositories.
        :param builtins.bool site_admin: Whether the user is a GitHub admin.
        :param builtins.str starred_url: The GitHub API URL for the collaborator's starred repositories.
        :param builtins.str subscriptions_url: The GitHub API URL for the collaborator's subscribed repositories.
        :param builtins.str type: The type of the collaborator (ex. `user`).
        :param builtins.str url: The GitHub API URL for the collaborator.
        """
...
class GetExternalGroupsExternalGroupResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str updated_at: the date the group was last updated.
        """
        pulumi.set(__self__, "group_id", group_id)
        pulumi.set(__self__, "group_name", group_name)
        pulumi.set(__self__, "updated_at", updated_at)
...
class GetIssueLabelsLabelResult(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str color: The hexadecimal color code for the label, without the leading #.
        :param builtins.str description: A short description of the label.
        :param builtins.str name: The name of the label.
        :param builtins.str url: The URL of the label.
        """
        pulumi.set(__self__, "color", color)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "name", name)
...
class GetOrganizationExternalIdentitiesIdentityResult(dict):
    def __init__(__self__, *,
                 login: builtins.str,
                 saml_identity: Mapping[str, builtins.str],
                 scim_identity: Mapping[str, builtins.str]):
        """
        :param builtins.str login: The username of the GitHub user
        :param Mapping[str, builtins.str] saml_identity: An Object containing the user's SAML data. This object will
               be empty if the user is not managed by SAML.
        :param Mapping[str, builtins.str] scim_identity: An Object contining the user's SCIM data. This object will
    ...
    def saml_identity(self) -> Mapping[str, builtins.str]:
        """
    ...
    def scim_identity(self) -> Mapping[str, builtins.str]:
        """
...
class GetOrganizationIpAllowListIpAllowListResult(dict):
    def __init__(__self__, *,
                 ...
                 updated_at: builtins.str):
        """
        :param builtins.str allow_list_value: A single IP address or range of IP addresses in CIDR notation.
        :param builtins.str created_at: Identifies the date and time when the object was created.
        :param builtins.str id: The ID of the IP allow list entry.
        :param builtins.bool is_active: Whether the entry is currently active.
        :param builtins.str name: The name of the IP allow list entry.
        :param builtins.str updated_at: Identifies the date and time when the object was last updated.
        """
...
class GetOrganizationTeamsTeamResult(dict):
    def __init__(__self__, *,
                 ...
                 slug: builtins.str):
        """
        :param builtins.str description: the team's description.
        :param builtins.int id: the ID of the team.
        :param Sequence[builtins.str] members: List of team members. Not returned if `summary_only = true`
        :param builtins.str name: the team's full name.
        :param builtins.str node_id: the Node ID of the team.
        :param Mapping[str, builtins.str] parent: the parent team.
        :param builtins.str privacy: the team's privacy type.
        :param Sequence[builtins.str] repositories: List of team repositories. Not returned if `summary_only = true`
        :param builtins.str slug: the slug of the team.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "id", id)
...
class GetOrganizationWebhooksWebhookResult(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.bool active: `true` if the webhook is active.
        :param builtins.int id: the ID of the webhook.
        :param builtins.str name: the name of the webhook.
        :param builtins.str type: the type of the webhook.
        :param builtins.str url: the url of the webhook.
        """
...
class GetReleaseAssetResult(dict):
    def __init__(__self__, *,
                 browser_download_url: builtins.str,
                 ...
                 url: builtins.str):
        """
        :param builtins.str browser_download_url: Browser download URL
        :param builtins.str content_type: MIME type of the asset
        :param builtins.str created_at: Date the asset was created
        :param builtins.int id: ID of the asset
        :param builtins.str label: Label for the asset
        :param builtins.str name: The file name of the asset
        :param builtins.str node_id: Node ID of the asset
        :param builtins.int size: Size in byte
        :param builtins.str updated_at: Date the asset was last updated
        :param builtins.str url: URL of the asset
        """
...
class GetRepositoryAutolinkReferencesAutolinkReferenceResult(dict):
    def __init__(__self__, *,
                 is_alphanumeric: builtins.bool,
                 key_prefix: builtins.str,
                 target_url_template: builtins.str):
        """
        :param builtins.bool is_alphanumeric: True if alphanumeric.
        :param builtins.str key_prefix: Key prefix.
        :param builtins.str target_url_template: Target url template.
        """
    ...
    def is_alphanumeric(self) -> builtins.bool:
        """
...
class GetRepositoryBranchesBranchResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the branch.
        :param builtins.bool protected: Whether the branch is protected.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protected", protected)
...
class GetRepositoryCustomPropertiesPropertyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str property_name: Name of the property
        :param Sequence[builtins.str] property_values: Value of the property
        """
...
class GetRepositoryDeployKeysKeyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int id: Key id
        :param builtins.str key: Key itself
        :param builtins.str title: Key title
        :param builtins.bool verified: `true` if the key was verified.
        """
        pulumi.set(__self__, "id", id)
...
class GetRepositoryDeploymentBranchPoliciesDeploymentBranchPolicyResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name pattern that branches must match in order to deploy to the environment.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class GetRepositoryEnvironmentsEnvironmentResult(dict):
    def __init__(__self__, *,
                 ...
                 node_id: builtins.str):
        """
        :param builtins.str name: Environment name.
        :param builtins.str node_id: Environment node id.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "node_id", node_id)
...
class GetRepositoryPageResult(dict):
    def __init__(__self__, *,
                 ...
                 cname: builtins.str,
                 custom404: builtins.bool,
                 html_url: builtins.str,
                 sources: Sequence['outputs.GetRepositoryPageSourceResult'],
                 status: builtins.str,
                 url: builtins.str):
        """
        :param builtins.str html_url: The URL to view the license details on GitHub.
        :param builtins.str url: The URL to access information about the license on GitHub.
        """
        pulumi.set(__self__, "build_type", build_type)
        pulumi.set(__self__, "cname", cname)
        pulumi.set(__self__, "custom404", custom404)
...
class GetRepositoryPageSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 path: builtins.str):
        """
        :param builtins.str path: The path to the license file within the repository.
        """
        pulumi.set(__self__, "branch", branch)
        pulumi.set(__self__, "path", path)
...
class GetRepositoryPullRequestsResultResult(dict):
    def __init__(__self__, *,
                 ...
                 base_sha: builtins.str,
                 body: builtins.str,
                 draft: builtins.bool,
                 head_owner: builtins.str,
                 head_ref: builtins.str,
                 head_repository: builtins.str,
                 head_sha: builtins.str,
                 labels: Sequence[builtins.str],
                 maintainer_can_modify: builtins.bool,
                 number: builtins.int,
                 opened_at: builtins.int,
                 opened_by: builtins.str,
                 state: builtins.str,
                 title: builtins.str,
                 updated_at: builtins.int):
        """
        :param builtins.str base_ref: If set, filters Pull Requests by base branch name.
        :param builtins.str base_sha: Head commit SHA of the Pull Request base.
        :param builtins.str body: Body of the Pull Request.
        :param builtins.bool draft: Indicates Whether this Pull Request is a draft.
        :param builtins.str head_owner: Owner of the Pull Request head repository.
        :param builtins.str head_ref: If set, filters Pull Requests by head user or head organization and branch name in the format of "user:ref-name" or "organization:ref-name". For example: "github:new-script-format" or "octocat:test-branch".
        :param builtins.str head_repository: Name of the Pull Request head repository.
        :param builtins.str head_sha: Head commit SHA of the Pull Request head.
        :param Sequence[builtins.str] labels: List of label names set on the Pull Request.
        :param builtins.bool maintainer_can_modify: Indicates whether the base repository maintainers can modify the Pull Request.
        :param builtins.int number: The number of the Pull Request within the repository.
        :param builtins.int opened_at: Unix timestamp indicating the Pull Request creation time.
        :param builtins.str opened_by: GitHub login of the user who opened the Pull Request.
        :param builtins.str state: If set, filters Pull Requests by state. Can be "open", "closed", or "all". Default: "open".
        :param builtins.str title: The title of the Pull Request.
        :param builtins.int updated_at: The timestamp of the last Pull Request update.
        """
    ...
    def opened_at(self) -> builtins.int:
        """
...
class GetRepositoryRepositoryLicenseResult(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str content: Content of the license file, encoded by encoding scheme mentioned below.
        :param builtins.str download_url: The URL to download the raw content of the license file.
        :param builtins.str encoding: The encoding used for the content (e.g., "base64").
        :param builtins.str git_url: The URL to access information about the license file as a Git blob.
        :param builtins.str html_url: The URL to view the license details on GitHub.
        :param Sequence['GetRepositoryRepositoryLicenseLicenseArgs'] licenses: `license` block consists of the fields documented below.
        :param builtins.str name: The name of the repository.
        :param builtins.str path: The path to the license file within the repository.
        :param builtins.str sha: The SHA hash of the license file.
        :param builtins.int size: The size of the license file in bytes.
        :param builtins.str type: The type of the content, (e.g., "file").
        :param builtins.str url: The URL to access information about the license on GitHub.
        """
...
class GetRepositoryRepositoryLicenseLicenseResult(dict):
    def __init__(__self__, *,
                 ...
                 key: builtins.str,
                 limitations: Sequence[builtins.str],
                 name: builtins.str,
                 permissions: Sequence[builtins.str],
                 spdx_id: builtins.str,
                 url: builtins.str):
        """
        :param builtins.str body: The text of the license.
        :param Sequence[builtins.str] conditions: Conditions associated with the license.
        :param builtins.str description: A description of the license.
        :param builtins.bool featured: Indicates if the license is featured.
        :param builtins.str html_url: The URL to view the license details on GitHub.
        :param builtins.str implementation: Details about the implementation of the license.
        :param builtins.str key: A key representing the license type (e.g., "apache-2.0").
        :param Sequence[builtins.str] limitations: Limitations associated with the license.
        :param builtins.str name: The name of the repository.
        :param Sequence[builtins.str] permissions: Permissions associated with the license.
        :param builtins.str spdx_id: The SPDX identifier for the license (e.g., "Apache-2.0").
        :param builtins.str url: The URL to access information about the license on GitHub.
        """
        pulumi.set(__self__, "body", body)
    ...
    @property
    @pulumi.getter
    def featured(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def limitations(self) -> Sequence[builtins.str]:
        """
...
class GetRepositoryTeamsTeamResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the repository.
        :param builtins.str permission: Team permission
        :param builtins.str slug: Team slug
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "permission", permission)
        pulumi.set(__self__, "slug", slug)
