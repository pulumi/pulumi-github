...
class ProjectCardArgs:
    def __init__(__self__, *,
                 ...
                 content_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] column_id: The ID of the card.
        :param pulumi.Input[builtins.int] content_id: `github_issue.issue_id`.
        :param pulumi.Input[builtins.str] content_type: Must be either `Issue` or `PullRequest`
        ...
        :param pulumi.Input[builtins.str] note: The note contents of the card. Markdown supported.
        """
    ...
    def content_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @content_id.setter
    def content_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ProjectCardState:
    def __init__(__self__, *,
                 card_id: Optional[pulumi.Input[builtins.int]] = None,
                 column_id: Optional[pulumi.Input[builtins.str]] = None,
                 content_id: Optional[pulumi.Input[builtins.int]] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] card_id: The ID of the card.
        :param pulumi.Input[builtins.str] column_id: The ID of the card.
        :param pulumi.Input[builtins.int] content_id: `github_issue.issue_id`.
        :param pulumi.Input[builtins.str] content_type: Must be either `Issue` or `PullRequest`
    ...
    def card_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The ID of the card.
        """
    ...
    @card_id.setter
    def card_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "card_id", value)

    @property
    @pulumi.getter(name="columnId")
    def column_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the card.
        """
        return pulumi.get(self, "column_id")
    ...
    @column_id.setter
    def column_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "column_id", value)
...
class ProjectCard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            content_type: Optional[pulumi.Input[builtins.str]] = None,
            etag: Optional[pulumi.Input[builtins.str]] = None,
            note: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectCard':
        """
    ...
    @property
    @pulumi.getter(name="cardId")
    def card_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the card.
        """
        return pulumi.get(self, "card_id")
    ...
    @property
    @pulumi.getter(name="columnId")
    def column_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the card.
        """
        return pulumi.get(self, "column_id")
    ...
    @property
    @pulumi.getter(name="contentId")
    def content_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        `github_issue.issue_id`.
        """
        return pulumi.get(self, "content_id")
