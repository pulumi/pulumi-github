...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 parallel_requests: Optional[pulumi.Input[builtins.bool]] = None,
                 read_delay_ms: Optional[pulumi.Input[builtins.int]] = None,
                 retry_delay_ms: Optional[pulumi.Input[builtins.int]] = None,
                 retryable_errors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 token: Optional[pulumi.Input[builtins.str]] = None,
                 write_delay_ms: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] base_url: The GitHub Base API URL
        :param pulumi.Input[builtins.bool] insecure: Enable `insecure` mode for testing purposes
        :param pulumi.Input[builtins.int] max_retries: Number of times to retry a request after receiving an error status codeDefaults to 3
        :param pulumi.Input[builtins.str] organization: The GitHub organization name to manage. Use this field instead of `owner` when managing organization accounts.
        :param pulumi.Input[builtins.str] owner: The GitHub owner name to manage. Use this field instead of `organization` when managing individual accounts.
        :param pulumi.Input[builtins.bool] parallel_requests: Allow the provider to make parallel API calls to GitHub. You may want to set it to true when you have a private Github
        ...
        :param pulumi.Input[builtins.int] read_delay_ms: Amount of time in milliseconds to sleep in between non-write requests to GitHub API. Defaults to 0ms if not set.
        :param pulumi.Input[builtins.int] retry_delay_ms: Amount of time in milliseconds to sleep in between requests to GitHub API after an error response. Defaults to 1000ms or
               1s if not set, the max_retries must be set to greater than zero.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] retryable_errors: Allow the provider to retry after receiving an error status code, the max_retries should be set for this to workDefaults
               to [500, 502, 503, 504]
        :param pulumi.Input[builtins.str] token: The OAuth token used to connect to GitHub. Anonymous mode is enabled if both `token` and `app_auth` are not set.
        :param pulumi.Input[builtins.int] write_delay_ms: Amount of time in milliseconds to sleep in between writes to GitHub API. Defaults to 1000ms or 1s if not set.
        """
    ...
    def parallel_requests(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def parallel_requests(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "parallel_requests", value)

    @property
    @pulumi.getter(name="readDelayMs")
    def read_delay_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def read_delay_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "read_delay_ms", value)

    @property
    @pulumi.getter(name="retryDelayMs")
    def retry_delay_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retry_delay_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retry_delay_ms", value)

    @property
    @pulumi.getter(name="retryableErrors")
    def retryable_errors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    def retryable_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    def write_delay_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def write_delay_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "write_delay_ms", value)


class Provider(pulumi.ProviderResource):

    pulumi_type = "pulumi:providers:github"
