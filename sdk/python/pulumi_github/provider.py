...
class Provider(pulumi.ProviderResource):
    def __init__(__self__, resource_name, opts=None, base_url=None, organization=None, owner=None, token=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[str] organization: (Deprecated) The GitHub organization name to manage.
        :param pulumi.Input[str] owner: The GitHub owner name to manage.
        ...
        if opts.id is None:
            ...
            if organization is not None:
                warnings.warn("Use owner field (or GITHUB_OWNER ENV variable)", DeprecationWarning)
                pulumi.log.warn("organization is deprecated: Use owner field (or GITHUB_OWNER ENV variable)")
