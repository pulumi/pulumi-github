...
class UserGpgKeyArgs:
    def __init__(__self__, *,
                 armored_public_key: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a UserGpgKey resource.
        :param pulumi.Input[builtins.str] armored_public_key: Your public GPG key, generated in ASCII-armored format.
    ...
    def armored_public_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def armored_public_key(self, value: pulumi.Input[builtins.str]):
...
class _UserGpgKeyState:
    def __init__(__self__, *,
                 armored_public_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] armored_public_key: Your public GPG key, generated in ASCII-armored format.
               See [Generating a new GPG key](https://help.github.com/articles/generating-a-new-gpg-key/) for help on creating a GPG key.
        :param pulumi.Input[builtins.str] key_id: The key ID of the GPG key, e.g. `3262EFF25BA0D270`
        """
    ...
    @property
    @pulumi.getter(name="armoredPublicKey")
    def armored_public_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Your public GPG key, generated in ASCII-armored format.
        See [Generating a new GPG key](https://help.github.com/articles/generating-a-new-gpg-key/) for help on creating a GPG key.
        """
    ...
    @armored_public_key.setter
    def armored_public_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "armored_public_key", value)
...
class UserGpgKey(pulumi.CustomResource):
    ...
    pulumi_type = "github:index/userGpgKey:UserGpgKey"
    ...
    def get(resource_name: str,
            ...
            armored_public_key: Optional[pulumi.Input[builtins.str]] = None,
            etag: Optional[pulumi.Input[builtins.str]] = None,
            key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserGpgKey':
        """
    ...
    @property
    @pulumi.getter(name="armoredPublicKey")
    def armored_public_key(self) -> pulumi.Output[builtins.str]:
        """
        Your public GPG key, generated in ASCII-armored format.
        See [Generating a new GPG key](https://help.github.com/articles/generating-a-new-gpg-key/) for help on creating a GPG key.
        """
