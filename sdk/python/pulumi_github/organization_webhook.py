...
class OrganizationWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] active: Indicate of the webhook should receive events. Defaults to `true`.
...
class OrganizationWebhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[builtins.str]] = None,
            events: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationWebhook':
        """
