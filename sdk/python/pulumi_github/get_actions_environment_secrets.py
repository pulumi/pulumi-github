...
def get_actions_environment_secrets(environment: Optional[builtins.str] = None,
...
def get_actions_environment_secrets_output(environment: Optional[pulumi.Input[builtins.str]] = None,
