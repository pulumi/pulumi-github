...
def get_team(membership_type: Optional[builtins.str] = None,
    ...
    :param builtins.str membership_type: Type of membership to be requested to fill the list of members. Can be either "all" or "immediate". Default: "all"
    :param builtins.int results_per_page: Set the number of results per graphql query. Reducing this number can alleviate timeout errors. Accepts a value between 0 - 100. Defaults to `100`.
    :param builtins.str slug: The team slug.
    :param builtins.bool summary_only: Exclude the members and repositories of the team from the returned result. Defaults to `false`.
    """
    __args__ = dict()
...
def get_team_output(membership_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
