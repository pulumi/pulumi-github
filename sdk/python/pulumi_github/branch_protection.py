...
class BranchProtectionArgs:
    def __init__(__self__, *,
                 ...
                 allows_deletions: Optional[pulumi.Input[builtins.bool]] = None,
                 allows_force_pushes: Optional[pulumi.Input[builtins.bool]] = None,
                 enforce_admins: Optional[pulumi.Input[builtins.bool]] = None,
                 force_push_bypassers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 lock_branch: Optional[pulumi.Input[builtins.bool]] = None,
                 require_conversation_resolution: Optional[pulumi.Input[builtins.bool]] = None,
                 require_signed_commits: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] pattern: Identifies the protection rule pattern.
        :param pulumi.Input[builtins.str] repository_id: The name or node ID of the repository associated with this branch protection rule.
        :param pulumi.Input[builtins.bool] allows_deletions: Boolean, setting this to `true` to allow the branch to be deleted.
        :param pulumi.Input[builtins.bool] allows_force_pushes: Boolean, setting this to `true` to allow force pushes on the branch to everyone. Set it to `false` if you specify `force_push_bypassers`.
        :param pulumi.Input[builtins.bool] enforce_admins: Boolean, setting this to `true` enforces status checks for repository administrators.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] force_push_bypassers: The list of actor Names/IDs that are allowed to bypass force push restrictions. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams. If the list is not empty, `allows_force_pushes` should be set to `false`.
        :param pulumi.Input[builtins.bool] lock_branch: Boolean, Setting this to `true` will make the branch read-only and preventing any pushes to it. Defaults to `false`
        :param pulumi.Input[builtins.bool] require_conversation_resolution: Boolean, setting this to `true` requires all conversations on code must be resolved before a pull request can be merged.
        :param pulumi.Input[builtins.bool] require_signed_commits: Boolean, setting this to `true` requires all commits to be signed with GPG.
        :param pulumi.Input[builtins.bool] required_linear_history: Boolean, setting this to `true` enforces a linear commit Git history, which prevents anyone from pushing merge commits to a branch
    ...
    def allows_deletions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allows_deletions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allows_deletions", value)

    @property
    @pulumi.getter(name="allowsForcePushes")
    def allows_force_pushes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allows_force_pushes(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allows_force_pushes", value)

    @property
    @pulumi.getter(name="enforceAdmins")
    def enforce_admins(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enforce_admins(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enforce_admins", value)

    @property
    @pulumi.getter(name="forcePushBypassers")
    def force_push_bypassers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def force_push_bypassers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "force_push_bypassers", value)

    @property
    @pulumi.getter(name="lockBranch")
    def lock_branch(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @lock_branch.setter
    def lock_branch(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "lock_branch", value)

    @property
    @pulumi.getter(name="requireConversationResolution")
    def require_conversation_resolution(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def require_conversation_resolution(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_conversation_resolution", value)

    @property
    @pulumi.getter(name="requireSignedCommits")
    def require_signed_commits(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def require_signed_commits(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BranchProtection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowsDeletions")
    def allows_deletions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, setting this to `true` to allow the branch to be deleted.
        """
        return pulumi.get(self, "allows_deletions")
    ...
    @property
    @pulumi.getter(name="allowsForcePushes")
    def allows_force_pushes(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, setting this to `true` to allow force pushes on the branch to everyone. Set it to `false` if you specify `force_push_bypassers`.
        """
        return pulumi.get(self, "allows_force_pushes")
    ...
    @property
    @pulumi.getter(name="enforceAdmins")
    def enforce_admins(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, setting this to `true` enforces status checks for repository administrators.
        """
        return pulumi.get(self, "enforce_admins")
    ...
    @property
    @pulumi.getter(name="forcePushBypassers")
    def force_push_bypassers(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of actor Names/IDs that are allowed to bypass force push restrictions. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams. If the list is not empty, `allows_force_pushes` should be set to `false`.
        """
        return pulumi.get(self, "force_push_bypassers")
    ...
    @property
    @pulumi.getter(name="lockBranch")
    def lock_branch(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, Setting this to `true` will make the branch read-only and preventing any pushes to it. Defaults to `false`
        """
        return pulumi.get(self, "lock_branch")
    ...
    @property
    @pulumi.getter(name="requireConversationResolution")
    def require_conversation_resolution(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, setting this to `true` requires all conversations on code must be resolved before a pull request can be merged.
        """
        return pulumi.get(self, "require_conversation_resolution")
    ...
    @property
    @pulumi.getter(name="requireSignedCommits")
    def require_signed_commits(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, setting this to `true` requires all commits to be signed with GPG.
        """
        return pulumi.get(self, "require_signed_commits")
    ...
    @property
    @pulumi.getter(name="requiredLinearHistory")
    def required_linear_history(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean, setting this to `true` enforces a linear commit Git history, which prevents anyone from pushing merge commits to a branch
        """
        return pulumi.get(self, "required_linear_history")
