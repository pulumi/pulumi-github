...
class BranchProtection(pulumi.CustomResource):
    ...
    def enforce_admins(self) -> Optional[bool]:
        """
    ...
    def require_signed_commits(self) -> Optional[bool]:
        """
    ...
    def required_pull_request_reviews(self) -> Optional['outputs.BranchProtectionRequiredPullRequestReviews']:
        """
    ...
    def required_status_checks(self) -> Optional['outputs.BranchProtectionRequiredStatusChecks']:
        """
    ...
    @property
    @pulumi.getter
    def restrictions(self) -> Optional['outputs.BranchProtectionRestrictions']:
        """
