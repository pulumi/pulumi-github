...
def get_organization_custom_role(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the custom role.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_organization_custom_role_output(name: Optional[pulumi.Input[builtins.str]] = None,
