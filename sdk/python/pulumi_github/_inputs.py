...
if not MYPY:
    class ActionsOrganizationPermissionsAllowedActionsConfigArgsDict(TypedDict):
        github_owned_allowed: pulumi.Input[builtins.bool]
        """
        Whether GitHub-owned actions are allowed in the organization.
        """
        patterns_alloweds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, monalisa/octocat@*, monalisa/octocat@v2, monalisa/*."
        """
        verified_allowed: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ActionsOrganizationPermissionsAllowedActionsConfigArgs:
    def __init__(__self__, *,
                 github_owned_allowed: pulumi.Input[builtins.bool],
                 patterns_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 verified_allowed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] github_owned_allowed: Whether GitHub-owned actions are allowed in the organization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] patterns_alloweds: Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, monalisa/octocat@*, monalisa/octocat@v2, monalisa/*."
        :param pulumi.Input[builtins.bool] verified_allowed: Whether actions in GitHub Marketplace from verified creators are allowed. Set to true to allow all GitHub Marketplace actions by verified creators.
        """
    ...
    def github_owned_allowed(self) -> pulumi.Input[builtins.bool]:
        """
        Whether GitHub-owned actions are allowed in the organization.
        """
    ...
    def github_owned_allowed(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "github_owned_allowed", value)

    @property
    @pulumi.getter(name="patternsAlloweds")
    def patterns_alloweds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, monalisa/octocat@*, monalisa/octocat@v2, monalisa/*."
        """
    ...
    def patterns_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "patterns_alloweds", value)

    @property
    @pulumi.getter(name="verifiedAllowed")
    def verified_allowed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether actions in GitHub Marketplace from verified creators are allowed. Set to true to allow all GitHub Marketplace actions by verified creators.
        """
    ...
    def verified_allowed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "verified_allowed", value)


if not MYPY:
    class ActionsOrganizationPermissionsEnabledRepositoriesConfigArgsDict(TypedDict):
        repository_ids: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]
        """
...
class ActionsOrganizationPermissionsEnabledRepositoriesConfigArgs:
    def __init__(__self__, *,
                 repository_ids: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] repository_ids: List of repository IDs to enable for GitHub Actions.
        """
        pulumi.set(__self__, "repository_ids", repository_ids)

    @property
    @pulumi.getter(name="repositoryIds")
    def repository_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
        List of repository IDs to enable for GitHub Actions.
        """
    ...
    def repository_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
...
class ActionsRepositoryPermissionsAllowedActionsConfigArgs:
    def __init__(__self__, *,
                 ...
                 verified_allowed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] github_owned_allowed: Whether GitHub-owned actions are allowed in the repository.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] patterns_alloweds: Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, monalisa/octocat@*, monalisa/octocat@v2, monalisa/*."
        :param pulumi.Input[builtins.bool] verified_allowed: Whether actions in GitHub Marketplace from verified creators are allowed. Set to true to allow all GitHub Marketplace actions by verified creators.
        """
        pulumi.set(__self__, "github_owned_allowed", github_owned_allowed)
...
if not MYPY:
    class BranchProtectionRequiredPullRequestReviewArgsDict(TypedDict):
        dismiss_stale_reviews: NotRequired[pulumi.Input[builtins.bool]]
        """
        Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        """
        dismissal_restrictions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        pull_request_bypassers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        require_code_owner_reviews: NotRequired[pulumi.Input[builtins.bool]]
        """
        Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        """
        require_last_push_approval: NotRequired[pulumi.Input[builtins.bool]]
        """
        Require that The most recent push must be approved by someone other than the last pusher.  Defaults to `false`
        """
        required_approving_review_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        restrict_dismissals: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BranchProtectionRequiredPullRequestReviewArgs:
    def __init__(__self__, *,
                 dismiss_stale_reviews: Optional[pulumi.Input[builtins.bool]] = None,
                 dismissal_restrictions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 pull_request_bypassers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 require_code_owner_reviews: Optional[pulumi.Input[builtins.bool]] = None,
                 require_last_push_approval: Optional[pulumi.Input[builtins.bool]] = None,
                 required_approving_review_count: Optional[pulumi.Input[builtins.int]] = None,
                 restrict_dismissals: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] dismiss_stale_reviews: Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dismissal_restrictions: The list of actor Names/IDs with dismissal access. If not empty, `restrict_dismissals` is ignored. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pull_request_bypassers: The list of actor Names/IDs that are allowed to bypass pull request requirements. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams.
        :param pulumi.Input[builtins.bool] require_code_owner_reviews: Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        :param pulumi.Input[builtins.bool] require_last_push_approval: Require that The most recent push must be approved by someone other than the last pusher.  Defaults to `false`
        :param pulumi.Input[builtins.int] required_approving_review_count: Require x number of approvals to satisfy branch protection requirements. If this is specified it must be a number between 0-6. This requirement matches GitHub's API, see the upstream [documentation](https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
               (https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
        :param pulumi.Input[builtins.bool] restrict_dismissals: Restrict pull request review dismissals.
        """
    ...
    def dismiss_stale_reviews(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        """
    ...
    def dismiss_stale_reviews(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "dismiss_stale_reviews", value)

    @property
    @pulumi.getter(name="dismissalRestrictions")
    def dismissal_restrictions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of actor Names/IDs with dismissal access. If not empty, `restrict_dismissals` is ignored. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams.
        """
    ...
    def dismissal_restrictions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dismissal_restrictions", value)

    @property
    @pulumi.getter(name="pullRequestBypassers")
    def pull_request_bypassers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of actor Names/IDs that are allowed to bypass pull request requirements. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams.
        """
    ...
    def pull_request_bypassers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "pull_request_bypassers", value)

    @property
    @pulumi.getter(name="requireCodeOwnerReviews")
    def require_code_owner_reviews(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        """
    ...
    def require_code_owner_reviews(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_code_owner_reviews", value)

    @property
    @pulumi.getter(name="requireLastPushApproval")
    def require_last_push_approval(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Require that The most recent push must be approved by someone other than the last pusher.  Defaults to `false`
        """
    ...
    def require_last_push_approval(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_last_push_approval", value)

    @property
    @pulumi.getter(name="requiredApprovingReviewCount")
    def required_approving_review_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Require x number of approvals to satisfy branch protection requirements. If this is specified it must be a number between 0-6. This requirement matches GitHub's API, see the upstream [documentation](https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
        (https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
        """
    ...
    def required_approving_review_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "required_approving_review_count", value)

    @property
    @pulumi.getter(name="restrictDismissals")
    def restrict_dismissals(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Restrict pull request review dismissals.
        """
    ...
    def restrict_dismissals(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "restrict_dismissals", value)


if not MYPY:
    class BranchProtectionRequiredStatusCheckArgsDict(TypedDict):
        contexts: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        strict: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BranchProtectionRequiredStatusCheckArgs:
    def __init__(__self__, *,
                 contexts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 strict: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contexts: The list of status checks to require in order to merge into this branch. No status checks are required by default.
               
               > Note: This attribute can contain multiple string patterns.
               If specified, usual value is the [job name](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idname). Otherwise, the [job id](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idname) is defaulted to.
               For workflows that use matrixes, append the matrix name to the value using the following pattern `(<matrix_value>[, <matrix_value>])`. Matrixes should be specified based on the order of matrix properties in the workflow file. See GitHub Documentation for more information.
               For workflows that use reusable workflows, the pattern is `<initial_workflow.jobs.job.[name/id]> / <reused-workflow.jobs.job.[name/id]>`. This can extend multiple levels.
        :param pulumi.Input[builtins.bool] strict: Require branches to be up to date before merging. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter
    def contexts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of status checks to require in order to merge into this branch. No status checks are required by default.
    ...
    @contexts.setter
    def contexts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class BranchProtectionRestrictPushArgsDict(TypedDict):
        blocks_creations: NotRequired[pulumi.Input[builtins.bool]]
        """
        Boolean, setting this to `false` allows people, teams, or apps to create new branches matching this rule. Defaults to `true`.
        """
        push_allowances: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BranchProtectionRestrictPushArgs:
    def __init__(__self__, *,
                 blocks_creations: Optional[pulumi.Input[builtins.bool]] = None,
                 push_allowances: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] blocks_creations: Boolean, setting this to `false` allows people, teams, or apps to create new branches matching this rule. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] push_allowances: A list of actor Names/IDs that may push to the branch. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams. Organization administrators, repository administrators, and users with the Maintain role on the repository can always push when all other requirements have passed.
        """
    ...
    def blocks_creations(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean, setting this to `false` allows people, teams, or apps to create new branches matching this rule. Defaults to `true`.
        """
    ...
    def blocks_creations(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "blocks_creations", value)

    @property
    @pulumi.getter(name="pushAllowances")
    def push_allowances(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of actor Names/IDs that may push to the branch. Actor names must either begin with a "/" for users or the organization name followed by a "/" for teams. Organization administrators, repository administrators, and users with the Maintain role on the repository can always push when all other requirements have passed.
        """
    ...
    def push_allowances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class BranchProtectionV3RequiredPullRequestReviewsArgsDict(TypedDict):
        ...
        Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        """
        dismissal_apps: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of app slugs with dismissal access.
        """
        dismissal_teams: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of team slugs with dismissal access.
        Always use `slug` of the team, **not** its name. Each team already **has** to have access to the repository.
        """
        dismissal_users: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of user logins with dismissal access
        """
        include_admins: NotRequired[pulumi.Input[builtins.bool]]
        require_code_owner_reviews: NotRequired[pulumi.Input[builtins.bool]]
        """
        Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        """
...
class BranchProtectionV3RequiredPullRequestReviewsArgs:
    def __init__(__self__, *,
                 ...
                 dismiss_stale_reviews: Optional[pulumi.Input[builtins.bool]] = None,
                 dismissal_apps: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 dismissal_teams: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 dismissal_users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_admins: Optional[pulumi.Input[builtins.bool]] = None,
                 require_code_owner_reviews: Optional[pulumi.Input[builtins.bool]] = None,
                 require_last_push_approval: Optional[pulumi.Input[builtins.bool]] = None,
                 required_approving_review_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] dismiss_stale_reviews: Dismiss approved reviews automatically when a new commit is pushed. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dismissal_apps: The list of app slugs with dismissal access.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dismissal_teams: The list of team slugs with dismissal access.
               Always use `slug` of the team, **not** its name. Each team already **has** to have access to the repository.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dismissal_users: The list of user logins with dismissal access
        :param pulumi.Input[builtins.bool] require_code_owner_reviews: Require an approved review in pull requests including files with a designated code owner. Defaults to `false`.
        :param pulumi.Input[builtins.bool] require_last_push_approval: Require that the most recent push must be approved by someone other than the last pusher.  Defaults to `false`
        :param pulumi.Input[builtins.int] required_approving_review_count: Require x number of approvals to satisfy branch protection requirements. If this is specified it must be a number between 0-6. This requirement matches GitHub's API, see the upstream [documentation](https://developer.github.com/v3/repos/branches/#parameters-1) for more information.
        """
    ...
    def dismissal_apps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of app slugs with dismissal access.
        """
    ...
    def dismissal_apps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dismissal_apps", value)

    @property
    @pulumi.getter(name="dismissalTeams")
    def dismissal_teams(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of team slugs with dismissal access.
        Always use `slug` of the team, **not** its name. Each team already **has** to have access to the repository.
        """
    ...
    def dismissal_teams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dismissal_teams", value)

    @property
    @pulumi.getter(name="dismissalUsers")
    def dismissal_users(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of user logins with dismissal access
        """
    ...
    def dismissal_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dismissal_users", value)

    @property
    @pulumi.getter(name="includeAdmins")
    @_utilities.deprecated("""Use enforce_admins instead""")
    def include_admins(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "include_admins")

    @include_admins.setter
    def include_admins(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BranchProtectionV3RequiredPullRequestReviewsBypassPullRequestAllowancesArgsDict(TypedDict):
        ...
        """
        teams: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BranchProtectionV3RequiredPullRequestReviewsBypassPullRequestAllowancesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: The list of app slugs allowed to bypass pull request requirements.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] teams: The list of team slugs allowed to bypass pull request requirements.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: The list of user logins allowed to bypass pull request requirements.
        """
        if apps is not None:
...
if not MYPY:
    class BranchProtectionV3RequiredStatusChecksArgsDict(TypedDict):
        checks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BranchProtectionV3RequiredStatusChecksArgs:
    def __init__(__self__, *,
                 checks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 contexts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_admins: Optional[pulumi.Input[builtins.bool]] = None,
                 strict: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] checks: The list of status checks to require in order to merge into this branch. No status checks are required by default. Checks should be strings containing the context and app_id like so "context:app_id".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contexts: [**DEPRECATED**] (Optional) The list of status checks to require in order to merge into this branch. No status checks are required by default.
    ...
    @property
    @pulumi.getter
    def checks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of status checks to require in order to merge into this branch. No status checks are required by default. Checks should be strings containing the context and app_id like so "context:app_id".
        """
    ...
    @checks.setter
    def checks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BranchProtectionV3RestrictionsArgs:
    def __init__(__self__, *,
                 ...
                 users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: The list of app slugs with push access.
               
               `restrictions` is only available for organization-owned repositories.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] teams: The list of team slugs with push access.
               Always use `slug` of the team, **not** its name. Each team already **has** to have access to the repository.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: The list of user logins with push access.
        """
        if apps is not None:
            pulumi.set(__self__, "apps", apps)
        if teams is not None:
...
if not MYPY:
    class EnterpriseActionsPermissionsEnabledOrganizationsConfigArgsDict(TypedDict):
        organization_ids: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]
        """
...
class EnterpriseActionsPermissionsEnabledOrganizationsConfigArgs:
    def __init__(__self__, *,
                 organization_ids: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] organization_ids: List of organization IDs to enable for GitHub Actions.
        """
        pulumi.set(__self__, "organization_ids", organization_ids)

    @property
    @pulumi.getter(name="organizationIds")
    def organization_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
        List of organization IDs to enable for GitHub Actions.
        """
    ...
    def organization_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
...
class IssueLabelsLabelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] color: A 6 character hex code, **without the leading #**, identifying the color of the label.
        :param pulumi.Input[builtins.str] name: The name of the label.
        :param pulumi.Input[builtins.str] description: A short description of the label.
        :param pulumi.Input[builtins.str] url: The URL to the issue label
        """
...
if not MYPY:
    class OrganizationRulesetBypassActorArgsDict(TypedDict):
        actor_id: pulumi.Input[builtins.int]
        """
        (Number) The ID of the actor that can bypass a ruleset.
        """
        actor_type: pulumi.Input[builtins.str]
        """
        The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`.
        """
        bypass_mode: pulumi.Input[builtins.str]
        """
...
class OrganizationRulesetBypassActorArgs:
    def __init__(__self__, *,
                 ...
                 bypass_mode: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] actor_id: (Number) The ID of the actor that can bypass a ruleset.
        :param pulumi.Input[builtins.str] actor_type: The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`.
        :param pulumi.Input[builtins.str] bypass_mode: (String) When the specified actor can bypass the ruleset. pull_request means that an actor can only bypass rules on pull requests. Can be one of: `always`, `pull_request`.
    ...
    def actor_id(self) -> pulumi.Input[builtins.int]:
        """
        (Number) The ID of the actor that can bypass a ruleset.
        """
    ...
    @actor_id.setter
    def actor_id(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "actor_id", value)

    @property
    @pulumi.getter(name="actorType")
    def actor_type(self) -> pulumi.Input[builtins.str]:
        """
        The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`.
        """
    ...
    @actor_type.setter
    def actor_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "actor_type", value)

    @property
    @pulumi.getter(name="bypassMode")
    def bypass_mode(self) -> pulumi.Input[builtins.str]:
        """
        (String) When the specified actor can bypass the ruleset. pull_request means that an actor can only bypass rules on pull requests. Can be one of: `always`, `pull_request`.
    ...
    @bypass_mode.setter
    def bypass_mode(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class OrganizationRulesetConditionsArgsDict(TypedDict):
        ...
        """
        repository_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
...
class OrganizationRulesetConditionsArgs:
    def __init__(__self__, *,
                 ...
                 repository_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] repository_ids: The repository IDs that the ruleset applies to. One of these IDs must match for the condition to pass. Conflicts with `repository_name`.
    ...
    @property
    @pulumi.getter(name="repositoryIds")
    def repository_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        The repository IDs that the ruleset applies to. One of these IDs must match for the condition to pass. Conflicts with `repository_name`.
        """
        return pulumi.get(self, "repository_ids")
    ...
    @repository_ids.setter
    def repository_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "repository_ids", value)
...
if not MYPY:
    class OrganizationRulesetConditionsRefNameArgsDict(TypedDict):
        excludes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Array of ref names or patterns to exclude. The condition will not pass if any of these patterns match.
        """
        includes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class OrganizationRulesetConditionsRefNameArgs:
    def __init__(__self__, *,
                 ...
                 includes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excludes: Array of ref names or patterns to exclude. The condition will not pass if any of these patterns match.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] includes: Array of ref names or patterns to include. One of these patterns must match for the condition to pass. Also accepts `~DEFAULT_BRANCH` to include the default branch or `~ALL` to include all branches.
        """
    ...
    @property
    @pulumi.getter
    def excludes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Array of ref names or patterns to exclude. The condition will not pass if any of these patterns match.
        """
    ...
    @excludes.setter
    def excludes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "excludes", value)

    @property
    @pulumi.getter
    def includes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Array of ref names or patterns to include. One of these patterns must match for the condition to pass. Also accepts `~DEFAULT_BRANCH` to include the default branch or `~ALL` to include all branches.
        """
    ...
    @includes.setter
    def includes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class OrganizationRulesetConditionsRepositoryNameArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excludes: Array of repository names or patterns to exclude. The condition will not pass if any of these patterns match.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] includes: Array of repository names or patterns to include. One of these patterns must match for the condition to pass. Also accepts `~ALL` to include all repositories.
        :param pulumi.Input[builtins.bool] protected: Whether renaming of target repositories is prevented.
        """
        pulumi.set(__self__, "excludes", excludes)
        pulumi.set(__self__, "includes", includes)
...
if not MYPY:
    class OrganizationRulesetRulesArgsDict(TypedDict):
        ...
        """
        creation: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Boolean) Only allow users with bypass permission to create matching refs.
        """
        deletion: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Boolean) Only allow users with bypass permissions to delete matching refs.
        """
        non_fast_forward: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        required_linear_history: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Boolean) Prevent merge commits from being pushed to matching branches.
        """
        required_signatures: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OrganizationRulesetRulesArgs:
    def __init__(__self__, *,
                 ...
                 creation: Optional[pulumi.Input[builtins.bool]] = None,
                 deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 non_fast_forward: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 required_linear_history: Optional[pulumi.Input[builtins.bool]] = None,
                 required_signatures: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] creation: (Boolean) Only allow users with bypass permission to create matching refs.
        :param pulumi.Input[builtins.bool] deletion: (Boolean) Only allow users with bypass permissions to delete matching refs.
        :param pulumi.Input[builtins.bool] non_fast_forward: (Boolean) Prevent users with push access from force pushing to branches.
        ...
        :param pulumi.Input[builtins.bool] required_linear_history: (Boolean) Prevent merge commits from being pushed to matching branches.
        :param pulumi.Input[builtins.bool] required_signatures: (Boolean) Commits pushed to matching branches must have verified signatures.
        ...
        :param pulumi.Input[builtins.bool] update: (Boolean) Only allow users with bypass permission to update matching refs.
        """
    ...
    @property
    @pulumi.getter
    def creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Boolean) Only allow users with bypass permission to create matching refs.
        """
    ...
    @creation.setter
    def creation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "creation", value)

    @property
    @pulumi.getter
    def deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Boolean) Only allow users with bypass permissions to delete matching refs.
        """
    ...
    @deletion.setter
    def deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "deletion", value)

    @property
    @pulumi.getter(name="nonFastForward")
    def non_fast_forward(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Boolean) Prevent users with push access from force pushing to branches.
        """
    ...
    def non_fast_forward(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def required_linear_history(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Boolean) Prevent merge commits from being pushed to matching branches.
        """
    ...
    def required_linear_history(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "required_linear_history", value)

    @property
    @pulumi.getter(name="requiredSignatures")
    def required_signatures(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Boolean) Commits pushed to matching branches must have verified signatures.
        """
    ...
    def required_signatures(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class OrganizationRulesetRulesBranchNamePatternArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator to use for matching. Can be one of: `starts_with`, `ends_with`, `contains`, `regex`.
        :param pulumi.Input[builtins.str] pattern: The pattern to match with.
        :param pulumi.Input[builtins.str] name: (String) The name of the ruleset.
        :param pulumi.Input[builtins.bool] negate: If true, the rule will fail if the pattern matches.
        """
...
if not MYPY:
    class OrganizationRulesetRulesPullRequestArgsDict(TypedDict):
        dismiss_stale_reviews_on_push: NotRequired[pulumi.Input[builtins.bool]]
        """
        New, reviewable commits pushed will dismiss previous pull request review approvals. Defaults to `false`.
        """
        require_code_owner_review: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        required_review_thread_resolution: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OrganizationRulesetRulesPullRequestArgs:
    def __init__(__self__, *,
                 dismiss_stale_reviews_on_push: Optional[pulumi.Input[builtins.bool]] = None,
                 require_code_owner_review: Optional[pulumi.Input[builtins.bool]] = None,
                 require_last_push_approval: Optional[pulumi.Input[builtins.bool]] = None,
                 required_approving_review_count: Optional[pulumi.Input[builtins.int]] = None,
                 required_review_thread_resolution: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] dismiss_stale_reviews_on_push: New, reviewable commits pushed will dismiss previous pull request review approvals. Defaults to `false`.
        :param pulumi.Input[builtins.bool] require_code_owner_review: Require an approving review in pull requests that modify files that have a designated code owner. Defaults to `false`.
        :param pulumi.Input[builtins.bool] require_last_push_approval: Whether the most recent reviewable push must be approved by someone other than the person who pushed it. Defaults to `false`.
        :param pulumi.Input[builtins.int] required_approving_review_count: The number of approving reviews that are required before a pull request can be merged. Defaults to `0`.
        :param pulumi.Input[builtins.bool] required_review_thread_resolution: All conversations on code must be resolved before a pull request can be merged. Defaults to `false`.
        """
    ...
    def dismiss_stale_reviews_on_push(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        New, reviewable commits pushed will dismiss previous pull request review approvals. Defaults to `false`.
        """
    ...
    def dismiss_stale_reviews_on_push(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "dismiss_stale_reviews_on_push", value)

    @property
    @pulumi.getter(name="requireCodeOwnerReview")
    def require_code_owner_review(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Require an approving review in pull requests that modify files that have a designated code owner. Defaults to `false`.
        """
    ...
    def require_code_owner_review(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def required_review_thread_resolution(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        All conversations on code must be resolved before a pull request can be merged. Defaults to `false`.
        """
    ...
    def required_review_thread_resolution(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningToolArgsDict(TypedDict):
        alerts_threshold: pulumi.Input[builtins.str]
        """
        ...
        """
        security_alerts_threshold: pulumi.Input[builtins.str]
        """
...
class OrganizationRulesetRulesRequiredCodeScanningRequiredCodeScanningToolArgs:
    def __init__(__self__, *,
                 ...
                 tool: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] alerts_threshold: The severity level at which code scanning results that raise alerts block a reference update. Can be one of: `none`, `errors`, `errors_and_warnings`, `all`.
        :param pulumi.Input[builtins.str] security_alerts_threshold: The severity level at which code scanning results that raise security alerts block a reference update. Can be one of: `none`, `critical`, `high_or_higher`, `medium_or_higher`, `all`.
        :param pulumi.Input[builtins.str] tool: The name of a code scanning tool.
        """
    ...
    def alerts_threshold(self) -> pulumi.Input[builtins.str]:
        """
        The severity level at which code scanning results that raise alerts block a reference update. Can be one of: `none`, `errors`, `errors_and_warnings`, `all`.
        """
    ...
    def alerts_threshold(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "alerts_threshold", value)

    @property
    @pulumi.getter(name="securityAlertsThreshold")
    def security_alerts_threshold(self) -> pulumi.Input[builtins.str]:
        """
        The severity level at which code scanning results that raise security alerts block a reference update. Can be one of: `none`, `critical`, `high_or_higher`, `medium_or_higher`, `all`.
        """
    ...
    def security_alerts_threshold(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class OrganizationRulesetRulesRequiredStatusChecksArgsDict(TypedDict):
        ...
        """
        strict_required_status_checks_policy: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OrganizationRulesetRulesRequiredStatusChecksArgs:
    def __init__(__self__, *,
                 ...
                 strict_required_status_checks_policy: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] strict_required_status_checks_policy: Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled. Defaults to `false`.
        """
    ...
    def strict_required_status_checks_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled. Defaults to `false`.
        """
    ...
    def strict_required_status_checks_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class OrganizationRulesetRulesRequiredStatusChecksRequiredCheckArgsDict(TypedDict):
        ...
        """
        integration_id: NotRequired[pulumi.Input[builtins.int]]
        """
...
class OrganizationRulesetRulesRequiredStatusChecksRequiredCheckArgs:
    def __init__(__self__, *,
                 context: pulumi.Input[builtins.str],
                 integration_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] context: The status check context name that must be present on the commit.
        :param pulumi.Input[builtins.int] integration_id: The optional integration ID that this status check must originate from.
        """
    ...
    def integration_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The optional integration ID that this status check must originate from.
        """
    ...
    def integration_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class OrganizationRulesetRulesRequiredWorkflowsRequiredWorkflowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] path: The path to the workflow YAML definition file.
        :param pulumi.Input[builtins.int] repository_id: The repository in which the workflow is defined.
        :param pulumi.Input[builtins.str] ref: The ref (branch or tag) of the workflow file to use.
        """
...
class OrganizationWebhookConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The content type for the payload. Valid values are either 'form' or 'json'.
        :param pulumi.Input[builtins.bool] insecure_ssl: Insecure SSL boolean toggle. Defaults to 'false'.
        :param pulumi.Input[builtins.str] secret: The shared secret for the webhook
        """
        pulumi.set(__self__, "url", url)
...
class ProviderAppAuthArgs:
    def __init__(__self__, *,
                 ...
                 pem_file: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The GitHub App ID.
        :param pulumi.Input[builtins.str] installation_id: The GitHub App installation instance ID.
        :param pulumi.Input[builtins.str] pem_file: The GitHub App PEM file contents.
        """
...
class RepositoryCollaboratorsIgnoreTeamArgs:
    def __init__(__self__, *,
                 team_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] team_id: ID or slug of the team to ignore.
        """
...
class RepositoryCollaboratorsTeamArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] team_id: The GitHub team id or the GitHub team slug.
        :param pulumi.Input[builtins.str] permission: The permission of the outside collaborators for the repository.
               Must be one of `pull`, `triage`, `push`, `maintain`, `admin` or the name of an existing [custom repository role](https://docs.github.com/en/enterprise-cloud@latest/organizations/managing-peoples-access-to-your-organization-with-roles/managing-custom-repository-roles-for-an-organization) within the organisation. Defaults to `pull`.
               Must be `push` for personal repositories. Defaults to `push`.
        """
        pulumi.set(__self__, "team_id", team_id)
...
class RepositoryCollaboratorsUserArgs:
    def __init__(__self__, *,
                 ...
                 permission: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] username: The user to add to the repository as a collaborator.
        :param pulumi.Input[builtins.str] permission: The permission of the outside collaborators for the repository.
               Must be one of `pull`, `push`, `maintain`, `triage` or `admin` or the name of an existing [custom repository role](https://docs.github.com/en/enterprise-cloud@latest/organizations/managing-peoples-access-to-your-organization-with-roles/managing-custom-repository-roles-for-an-organization) within the organization for organization-owned repositories.
               Must be `push` for personal repositories. Defaults to `push`.
        """
...
if not MYPY:
    class RepositoryEnvironmentDeploymentBranchPolicyArgsDict(TypedDict):
        custom_branch_policies: pulumi.Input[builtins.bool]
        """
        Whether only branches that match the specified name patterns can deploy to this environment.
        """
        protected_branches: pulumi.Input[builtins.bool]
        """
...
class RepositoryEnvironmentDeploymentBranchPolicyArgs:
    def __init__(__self__, *,
                 ...
                 protected_branches: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] custom_branch_policies: Whether only branches that match the specified name patterns can deploy to this environment.
        :param pulumi.Input[builtins.bool] protected_branches: Whether only branches with branch protection rules can deploy to this environment.
        """
    ...
    def custom_branch_policies(self) -> pulumi.Input[builtins.bool]:
        """
        Whether only branches that match the specified name patterns can deploy to this environment.
        """
    ...
    def custom_branch_policies(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "custom_branch_policies", value)

    @property
    @pulumi.getter(name="protectedBranches")
    def protected_branches(self) -> pulumi.Input[builtins.bool]:
        """
        Whether only branches with branch protection rules can deploy to this environment.
        """
    ...
    def protected_branches(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "protected_branches", value)


if not MYPY:
    class RepositoryEnvironmentReviewerArgsDict(TypedDict):
        teams: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
        Up to 6 IDs for teams who may review jobs that reference the environment. Reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.
        """
        users: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
...
class RepositoryEnvironmentReviewerArgs:
    def __init__(__self__, *,
                 teams: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] teams: Up to 6 IDs for teams who may review jobs that reference the environment. Reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] users: Up to 6 IDs for users who may review jobs that reference the environment. Reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.
        """
        if teams is not None:
            pulumi.set(__self__, "teams", teams)
        if users is not None:
    ...
    @property
    @pulumi.getter
    def teams(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        Up to 6 IDs for teams who may review jobs that reference the environment. Reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.
        """
        return pulumi.get(self, "teams")
    ...
    @teams.setter
    def teams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "teams", value)
...
if not MYPY:
    class RepositoryPagesArgsDict(TypedDict):
        ...
        """
        custom404: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the rendered GitHub Pages site has a custom 404 page.
        """
        html_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RepositoryPagesArgs:
    def __init__(__self__, *,
                 ...
                 custom404: Optional[pulumi.Input[builtins.bool]] = None,
                 html_url: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input['RepositoryPagesSourceArgs']] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] build_type: The type of GitHub Pages site to build. Can be `legacy` or `workflow`. If you use `legacy` as build type you need to set the option `source`.
        :param pulumi.Input[builtins.str] cname: The custom domain for the repository. This can only be set after the repository has been created.
        :param pulumi.Input[builtins.bool] custom404: Whether the rendered GitHub Pages site has a custom 404 page.
        :param pulumi.Input[builtins.str] html_url: The absolute URL (including scheme) of the rendered GitHub Pages site e.g. `https://username.github.io`.
        ...
        :param pulumi.Input[builtins.str] status: The GitHub Pages site's build status e.g. `building` or `built`.
        """
    ...
    @property
    @pulumi.getter
    def custom404(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the rendered GitHub Pages site has a custom 404 page.
        """
    ...
    @custom404.setter
    def custom404(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RepositoryPagesSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] branch: The repository branch used to publish the site's source files. (i.e. `main` or `gh-pages`.
        :param pulumi.Input[builtins.str] path: The repository directory from which the site publishes (Default: `/`).
        """
...
class RepositoryRulesetBypassActorArgs:
    def __init__(__self__, *,
                 ...
                 bypass_mode: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] actor_id: (Number) The ID of the actor that can bypass a ruleset. If `actor_type` is `Integration`, `actor_id` is a GitHub App ID. App ID can be obtained by following instructions from the [Get an App API docs](https://docs.github.com/en/rest/apps/apps?apiVersion=2022-11-28#get-an-app)
        :param pulumi.Input[builtins.str] actor_type: The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`.
        :param pulumi.Input[builtins.str] bypass_mode: (String) When the specified actor can bypass the ruleset. pull_request means that an actor can only bypass rules on pull requests. Can be one of: `always`, `pull_request`.
...
if not MYPY:
    class RepositoryRulesetRulesArgsDict(TypedDict):
        ...
        (Boolean) Only allow users with bypass permission to update matching refs.
        """
        update_allows_fetch_and_merge: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RepositoryRulesetRulesArgs:
    def __init__(__self__, *,
                 ...
                 update: Optional[pulumi.Input[builtins.bool]] = None,
                 update_allows_fetch_and_merge: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    def update_allows_fetch_and_merge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Boolean) Branch can pull changes from its upstream repository. This is only applicable to forked repositories. Requires `update` to be set to `true`. Note: behaviour is affected by a known bug on the GitHub side which may cause issues when using this parameter.
        """
    ...
    def update_allows_fetch_and_merge(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class RepositoryRulesetRulesMergeQueueArgsDict(TypedDict):
        check_response_timeout_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        grouping_strategy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RepositoryRulesetRulesMergeQueueArgs:
    def __init__(__self__, *,
                 check_response_timeout_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 grouping_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 max_entries_to_build: Optional[pulumi.Input[builtins.int]] = None,
                 max_entries_to_merge: Optional[pulumi.Input[builtins.int]] = None,
                 merge_method: Optional[pulumi.Input[builtins.str]] = None,
                 min_entries_to_merge: Optional[pulumi.Input[builtins.int]] = None,
                 min_entries_to_merge_wait_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] check_response_timeout_minutes: Maximum time for a required status check to report a conclusion. After this much time has elapsed, checks that have not reported a conclusion will be assumed to have failed. Defaults to `60`.
        :param pulumi.Input[builtins.str] grouping_strategy: When set to ALLGREEN, the merge commit created by merge queue for each PR in the group must pass all required checks to merge. When set to HEADGREEN, only the commit at the head of the merge group, i.e. the commit containing changes from all of the PRs in the group, must pass its required checks to merge. Can be one of: ALLGREEN, HEADGREEN. Defaults to `ALLGREEN`.
        :param pulumi.Input[builtins.int] max_entries_to_build: Limit the number of queued pull requests requesting checks and workflow runs at the same time. Defaults to `5`.
        :param pulumi.Input[builtins.int] max_entries_to_merge: The maximum number of PRs that will be merged together in a group. Defaults to `5`.
        :param pulumi.Input[builtins.str] merge_method: Method to use when merging changes from queued pull requests. Can be one of: MERGE, SQUASH, REBASE. Defaults to `MERGE`.
        :param pulumi.Input[builtins.int] min_entries_to_merge: The minimum number of PRs that will be merged together in a group. Defaults to `1`.
        :param pulumi.Input[builtins.int] min_entries_to_merge_wait_minutes: The time merge queue should wait after the first PR is added to the queue for the minimum group size to be met. After this time has elapsed, the minimum group size will be ignored and a smaller group will be merged. Defaults to `5`.
        """
    ...
    def check_response_timeout_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum time for a required status check to report a conclusion. After this much time has elapsed, checks that have not reported a conclusion will be assumed to have failed. Defaults to `60`.
        """
    ...
    def check_response_timeout_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "check_response_timeout_minutes", value)

    @property
    @pulumi.getter(name="groupingStrategy")
    def grouping_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When set to ALLGREEN, the merge commit created by merge queue for each PR in the group must pass all required checks to merge. When set to HEADGREEN, only the commit at the head of the merge group, i.e. the commit containing changes from all of the PRs in the group, must pass its required checks to merge. Can be one of: ALLGREEN, HEADGREEN. Defaults to `ALLGREEN`.
        """
    ...
    def grouping_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grouping_strategy", value)

    @property
    @pulumi.getter(name="maxEntriesToBuild")
    def max_entries_to_build(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Limit the number of queued pull requests requesting checks and workflow runs at the same time. Defaults to `5`.
        """
    ...
    def max_entries_to_build(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_entries_to_build", value)

    @property
    @pulumi.getter(name="maxEntriesToMerge")
    def max_entries_to_merge(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of PRs that will be merged together in a group. Defaults to `5`.
        """
    ...
    def max_entries_to_merge(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def min_entries_to_merge(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum number of PRs that will be merged together in a group. Defaults to `1`.
        """
    ...
    def min_entries_to_merge(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_entries_to_merge", value)

    @property
    @pulumi.getter(name="minEntriesToMergeWaitMinutes")
    def min_entries_to_merge_wait_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The time merge queue should wait after the first PR is added to the queue for the minimum group size to be met. After this time has elapsed, the minimum group size will be ignored and a smaller group will be merged. Defaults to `5`.
        """
    ...
    def min_entries_to_merge_wait_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class RepositoryRulesetRulesRequiredDeploymentsArgsDict(TypedDict):
        required_deployment_environments: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class RepositoryRulesetRulesRequiredDeploymentsArgs:
    def __init__(__self__, *,
                 required_deployment_environments: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] required_deployment_environments: The environments that must be successfully deployed to before branches can be merged.
        """
    ...
    def required_deployment_environments(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The environments that must be successfully deployed to before branches can be merged.
        """
    ...
    def required_deployment_environments(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class RepositoryRulesetRulesRequiredStatusChecksArgsDict(TypedDict):
        ...
        Status checks that are required. Several can be defined.
        """
        do_not_enforce_on_create: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RepositoryRulesetRulesRequiredStatusChecksArgs:
    def __init__(__self__, *,
                 ...
                 do_not_enforce_on_create: Optional[pulumi.Input[builtins.bool]] = None,
                 strict_required_status_checks_policy: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] do_not_enforce_on_create: Allow repositories and branches to be created if a check would otherwise prohibit it.
        :param pulumi.Input[builtins.bool] strict_required_status_checks_policy: Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled. Defaults to `false`.
        """
        pulumi.set(__self__, "required_checks", required_checks)
    ...
    def do_not_enforce_on_create(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allow repositories and branches to be created if a check would otherwise prohibit it.
        """
    ...
    def do_not_enforce_on_create(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RepositorySecurityAndAnalysisAdvancedSecurityArgs:
    def __init__(__self__, *,
                 status: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] status: Set to `enabled` to enable advanced security features on the repository. Can be `enabled` or `disabled`.
        """
        pulumi.set(__self__, "status", status)
...
if not MYPY:
    class RepositoryTemplateArgsDict(TypedDict):
        ...
        """
        include_all_branches: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RepositoryTemplateArgs:
    def __init__(__self__, *,
                 owner: pulumi.Input[builtins.str],
                 repository: pulumi.Input[builtins.str],
                 include_all_branches: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] owner: The GitHub organization or user the template repository is owned by.
        :param pulumi.Input[builtins.str] repository: The name of the template repository.
        :param pulumi.Input[builtins.bool] include_all_branches: Whether the new repository should include all the branches from the template repository (defaults to false, which includes only the default branch from the template).
        """
    ...
    def include_all_branches(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the new repository should include all the branches from the template repository (defaults to false, which includes only the default branch from the template).
        """
    ...
    def include_all_branches(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RepositoryWebhookConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The content type for the payload. Valid values are either `form` or `json`.
        :param pulumi.Input[builtins.bool] insecure_ssl: Insecure SSL boolean toggle. Defaults to `false`.
        :param pulumi.Input[builtins.str] secret: The shared secret for the webhook. [See API documentation](https://developer.github.com/v3/repos/hooks/#create-a-hook).
        """
        pulumi.set(__self__, "url", url)
        if content_type is not None:
            pulumi.set(__self__, "content_type", content_type)
...
class TeamMembersMemberArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] username: The user to add to the team.
        :param pulumi.Input[builtins.str] role: The role of the user within the team.
               Must be one of `member` or `maintainer`. Defaults to `member`.
        """
        pulumi.set(__self__, "username", username)
        if role is not None:
...
if not MYPY:
    class TeamSettingsReviewRequestDelegationArgsDict(TypedDict):
        ...
        """
        member_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TeamSettingsReviewRequestDelegationArgs:
    def __init__(__self__, *,
                 ...
                 member_count: Optional[pulumi.Input[builtins.int]] = None,
                 notify: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] algorithm: The algorithm to use when assigning pull requests to team members. Supported values are 'ROUND_ROBIN' and 'LOAD_BALANCE'.
        :param pulumi.Input[builtins.int] member_count: The number of team members to assign to a pull request.
        :param pulumi.Input[builtins.bool] notify: whether to notify the entire team when at least one member is also assigned to the pull request.
        """
    ...
    def member_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of team members to assign to a pull request.
        """
    ...
    @member_count.setter
    def member_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class TeamSyncGroupMappingGroupArgs:
    def __init__(__self__, *,
                 ...
                 group_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] group_description: The description of the IdP group.
        :param pulumi.Input[builtins.str] group_id: The ID of the IdP group.
        :param pulumi.Input[builtins.str] group_name: The name of the IdP group.
        """
