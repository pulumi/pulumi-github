...
class TeamArgs:
    def __init__(__self__, *,
                 create_default_maintainer: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_dn: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_team_id: Optional[pulumi.Input[builtins.str]] = None,
                 parent_team_read_id: Optional[pulumi.Input[builtins.str]] = None,
                 parent_team_read_slug: Optional[pulumi.Input[builtins.str]] = None,
                 privacy: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Team resource.
        :param pulumi.Input[builtins.bool] create_default_maintainer: Adds a default maintainer to the team. Defaults to `false` and adds the creating user to the team when `true`.
        :param pulumi.Input[builtins.str] description: A description of the team.
        :param pulumi.Input[builtins.str] ldap_dn: The LDAP Distinguished Name of the group where membership will be synchronized. Only available in GitHub Enterprise Server.
        :param pulumi.Input[builtins.str] name: The name of the team.
        :param pulumi.Input[builtins.str] parent_team_id: The ID or slug of the parent team, if this is a nested team.
        :param pulumi.Input[builtins.str] parent_team_read_id: The id of the parent team read in Github.
        :param pulumi.Input[builtins.str] parent_team_read_slug: The id of the parent team read in Github.
        :param pulumi.Input[builtins.str] privacy: The level of privacy for the team. Must be one of `secret` or `closed`.
               Defaults to `secret`.
        """
    ...
    def create_default_maintainer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_default_maintainer(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ldap_dn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ldap_dn.setter
    def ldap_dn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def parent_team_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_team_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_team_id", value)

    @property
    @pulumi.getter(name="parentTeamReadId")
    def parent_team_read_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_team_read_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_team_read_id", value)

    @property
    @pulumi.getter(name="parentTeamReadSlug")
    def parent_team_read_slug(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the parent team read in Github.
        """
    ...
    def parent_team_read_slug(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TeamState:
    def __init__(__self__, *,
                 ...
                 ldap_dn: Optional[pulumi.Input[builtins.str]] = None,
                 members_count: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ldap_dn: The LDAP Distinguished Name of the group where membership will be synchronized. Only available in GitHub Enterprise Server.
        :param pulumi.Input[builtins.str] name: The name of the team.
        :param pulumi.Input[builtins.str] node_id: The Node ID of the created team.
        :param pulumi.Input[builtins.str] parent_team_id: The ID or slug of the parent team, if this is a nested team.
        :param pulumi.Input[builtins.str] parent_team_read_id: The id of the parent team read in Github.
        :param pulumi.Input[builtins.str] parent_team_read_slug: The id of the parent team read in Github.
        :param pulumi.Input[builtins.str] privacy: The level of privacy for the team. Must be one of `secret` or `closed`.
               Defaults to `secret`.
        :param pulumi.Input[builtins.str] slug: The slug of the created team, which may or may not differ from `name`,
    ...
    def members_count(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "members_count")

    @members_count.setter
    def members_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Team(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent_team_read_slug: Optional[pulumi.Input[builtins.str]] = None,
            privacy: Optional[pulumi.Input[builtins.str]] = None,
            slug: Optional[pulumi.Input[builtins.str]] = None) -> 'Team':
        """
    ...
    @property
    @pulumi.getter(name="createDefaultMaintainer")
    def create_default_maintainer(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Adds a default maintainer to the team. Defaults to `false` and adds the creating user to the team when `true`.
        """
        return pulumi.get(self, "create_default_maintainer")
    ...
    @property
    @pulumi.getter(name="ldapDn")
    def ldap_dn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The LDAP Distinguished Name of the group where membership will be synchronized. Only available in GitHub Enterprise Server.
        """
        return pulumi.get(self, "ldap_dn")
    ...
    @property
    @pulumi.getter(name="membersCount")
    def members_count(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "members_count")
    ...
    @property
    @pulumi.getter(name="parentTeamId")
    def parent_team_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID or slug of the parent team, if this is a nested team.
        """
        return pulumi.get(self, "parent_team_id")
    ...
    @property
    @pulumi.getter(name="parentTeamReadId")
    def parent_team_read_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the parent team read in Github.
        """
        return pulumi.get(self, "parent_team_read_id")
    ...
    @property
    @pulumi.getter(name="parentTeamReadSlug")
    def parent_team_read_slug(self) -> pulumi.Output[builtins.str]:
        """
        The id of the parent team read in Github.
        """
        return pulumi.get(self, "parent_team_read_slug")
