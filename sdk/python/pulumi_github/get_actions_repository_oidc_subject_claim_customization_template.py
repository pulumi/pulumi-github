...
def get_actions_repository_oidc_subject_claim_customization_template(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of the repository to get the OpenID Connect subject claim customization template for.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_actions_repository_oidc_subject_claim_customization_template_output(name: Optional[pulumi.Input[_builtins.str]] = None,
