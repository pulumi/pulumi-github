...
class ActionsOrganizationOidcSubjectClaimCustomizationTemplateArgs:
    def __init__(__self__, *,
                 include_claim_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
    ...
    def include_claim_keys(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def include_claim_keys(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ActionsOrganizationOidcSubjectClaimCustomizationTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            include_claim_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ActionsOrganizationOidcSubjectClaimCustomizationTemplate':
        """
    ...
    @property
    @pulumi.getter(name="includeClaimKeys")
    def include_claim_keys(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of OpenID Connect claims.
        """
        return pulumi.get(self, "include_claim_keys")
