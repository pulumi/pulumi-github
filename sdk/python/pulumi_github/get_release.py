...
class GetReleaseResult:
    ...
    def asserts_url(self) -> _builtins.str:
        """
    ...
    def assets_url(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def prerelease(self) -> _builtins.bool:
        """
    ...
    def release_id(self) -> Optional[_builtins.int]:
        """
        ID of release
        """
    ...
    def retrieve_by(self) -> _builtins.str:
        return pulumi.get(self, "retrieve_by")

    @_builtins.property
    @pulumi.getter(name="tarballUrl")
    def tarball_url(self) -> _builtins.str:
        """
    ...
    def target_commitish(self) -> _builtins.str:
        """
    ...
    def zipball_url(self) -> _builtins.str:
        """
...
def get_release(owner: Optional[_builtins.str] = None,
                release_id: Optional[_builtins.int] = None,
                release_tag: Optional[_builtins.str] = None,
                repository: Optional[_builtins.str] = None,
                retrieve_by: Optional[_builtins.str] = None,
    ...
    :param _builtins.str release_tag: Tag of the release to retrieve. Must be specified when `retrieve_by` = `tag`.
    :param _builtins.str repository: Name of the repository to retrieve the release from.
    :param _builtins.str retrieve_by: Describes how to fetch the release. Valid values are `id`, `tag`, `latest`.
    """
    __args__ = dict()
