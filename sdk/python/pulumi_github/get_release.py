...
class GetReleaseResult:
    ...
    def release_id(self) -> Optional[builtins.int]:
        """
        ID of release
        """
...
def get_release(owner: Optional[builtins.str] = None,
                release_id: Optional[builtins.int] = None,
                release_tag: Optional[builtins.str] = None,
                repository: Optional[builtins.str] = None,
                retrieve_by: Optional[builtins.str] = None,
    ...
    :param builtins.str owner: Owner of the repository.
    :param builtins.int release_id: ID of the release to retrieve. Must be specified when `retrieve_by` = `id`.
    :param builtins.str release_tag: Tag of the release to retrieve. Must be specified when `retrieve_by` = `tag`.
    :param builtins.str repository: Name of the repository to retrieve the release from.
    :param builtins.str retrieve_by: Describes how to fetch the release. Valid values are `id`, `tag`, `latest`.
    """
    __args__ = dict()
...
def get_release_output(owner: Optional[pulumi.Input[builtins.str]] = None,
                       release_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                       release_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       repository: Optional[pulumi.Input[builtins.str]] = None,
                       retrieve_by: Optional[pulumi.Input[builtins.str]] = None,
