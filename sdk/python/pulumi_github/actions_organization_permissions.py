...
class ActionsOrganizationPermissionsArgs:
    def __init__(__self__, *,
                 enabled_repositories: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] enabled_repositories: The policy that controls the repositories in the organization that are allowed to run GitHub Actions. Can be one of: `all`, `none`, or `selected`.
    ...
    def enabled_repositories(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def enabled_repositories(self, value: pulumi.Input[builtins.str]):
...
class _ActionsOrganizationPermissionsState:
    def __init__(__self__, *,
                 allowed_actions: Optional[pulumi.Input[builtins.str]] = None,
                 allowed_actions_config: Optional[pulumi.Input['ActionsOrganizationPermissionsAllowedActionsConfigArgs']] = None,
                 enabled_repositories: Optional[pulumi.Input[builtins.str]] = None,
                 enabled_repositories_config: Optional[pulumi.Input['ActionsOrganizationPermissionsEnabledRepositoriesConfigArgs']] = None):
        """
    ...
    @property
    @pulumi.getter(name="enabledRepositories")
    def enabled_repositories(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The policy that controls the repositories in the organization that are allowed to run GitHub Actions. Can be one of: `all`, `none`, or `selected`.
        """
        return pulumi.get(self, "enabled_repositories")
    ...
    @enabled_repositories.setter
    def enabled_repositories(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enabled_repositories", value)
...
class ActionsOrganizationPermissions(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enabledRepositories")
    def enabled_repositories(self) -> pulumi.Output[builtins.str]:
        """
        The policy that controls the repositories in the organization that are allowed to run GitHub Actions. Can be one of: `all`, `none`, or `selected`.
        """
        return pulumi.get(self, "enabled_repositories")
