...
class RepositoryDependabotSecurityUpdatesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: The state of the automated security fixes.
...
class RepositoryDependabotSecurityUpdates(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryDependabotSecurityUpdates':
        """
