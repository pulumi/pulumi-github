...
def get_repository_milestone(number: Optional[builtins.int] = None,
    ...
    :param builtins.int number: The number of the milestone.
    :param builtins.str owner: Owner of the repository.
    :param builtins.str repository: Name of the repository to retrieve the milestone from.
    """
    __args__ = dict()
...
def get_repository_milestone_output(number: Optional[pulumi.Input[builtins.int]] = None,
