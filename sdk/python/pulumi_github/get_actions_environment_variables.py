...
def get_actions_environment_variables(environment: Optional[builtins.str] = None,
...
def get_actions_environment_variables_output(environment: Optional[pulumi.Input[builtins.str]] = None,
