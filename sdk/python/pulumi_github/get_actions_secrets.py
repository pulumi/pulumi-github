...
def get_actions_secrets(full_name: Optional[_builtins.str] = None,
...
def get_actions_secrets_output(full_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
