...
def get_repository_pull_request(base_repository: Optional[_builtins.str] = None,
    ...
    :param _builtins.str base_repository: Name of the base repository to retrieve the Pull Request from.
