...
def get_repository_pull_request(base_repository: Optional[builtins.str] = None,
    ...
    :param builtins.str base_repository: Name of the base repository to retrieve the Pull Request from.
...
def get_repository_pull_request_output(base_repository: Optional[pulumi.Input[builtins.str]] = None,
