...
class RepositoryMilestoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] owner: The owner of the GitHub Repository.
        :param pulumi.Input[builtins.str] repository: The name of the GitHub Repository.
        :param pulumi.Input[builtins.str] title: The title of the milestone.
        :param pulumi.Input[builtins.str] description: A description of the milestone.
        :param pulumi.Input[builtins.str] due_date: The milestone due date. In `yyyy-mm-dd` format.
        :param pulumi.Input[builtins.str] state: The state of the milestone. Either `open` or `closed`. Default: `open`
        """
...
class _RepositoryMilestoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description of the milestone.
        :param pulumi.Input[builtins.str] due_date: The milestone due date. In `yyyy-mm-dd` format.
        :param pulumi.Input[builtins.int] number: The number of the milestone.
        :param pulumi.Input[builtins.str] owner: The owner of the GitHub Repository.
        :param pulumi.Input[builtins.str] repository: The name of the GitHub Repository.
        :param pulumi.Input[builtins.str] state: The state of the milestone. Either `open` or `closed`. Default: `open`
        :param pulumi.Input[builtins.str] title: The title of the milestone.
...
class RepositoryMilestone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repository: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            title: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryMilestone':
        """
