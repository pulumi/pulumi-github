...
class RepositoryMilestoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state: The state of the milestone. Either `open` or `closed`. Default: `open`
        """
...
class RepositoryMilestone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repository: Optional[pulumi.Input[_builtins.str]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            title: Optional[pulumi.Input[_builtins.str]] = None) -> 'RepositoryMilestone':
        """
