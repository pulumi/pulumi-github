...
def get_repository_webhooks(repository: Optional[builtins.str] = None,
...
def get_repository_webhooks_output(repository: Optional[pulumi.Input[builtins.str]] = None,
