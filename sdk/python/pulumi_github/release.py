...
class ReleaseArgs:
    def __init__(__self__, *,
                 ...
                 discussion_category_name: Optional[pulumi.Input[builtins.str]] = None,
                 draft: Optional[pulumi.Input[builtins.bool]] = None,
                 generate_release_notes: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 prerelease: Optional[pulumi.Input[builtins.bool]] = None,
                 target_commitish: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] body: Text describing the contents of the tag.
        :param pulumi.Input[builtins.str] discussion_category_name: If specified, a discussion of the specified category is created and linked to the release. The value must be a category that already exists in the repository. For more information, see [Managing categories for discussions in your repository](https://docs.github.com/discussions/managing-discussions-for-your-community/managing-categories-for-discussions-in-your-repository).
        :param pulumi.Input[builtins.bool] draft: Set to `false` to create a published release.
        :param pulumi.Input[builtins.bool] generate_release_notes: Set to `true` to automatically generate the name and body for this release. If `name` is specified, the specified `name` will be used; otherwise, a name will be automatically generated. If `body` is specified, the `body` will be pre-pended to the automatically generated notes.
        :param pulumi.Input[builtins.str] name: The name of the release.
        :param pulumi.Input[builtins.bool] prerelease: Set to `false` to identify the release as a full release.
        :param pulumi.Input[builtins.str] target_commitish: The branch name or commit SHA the tag is created from. Defaults to the default branch of the repository.
        """
    ...
    def discussion_category_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def discussion_category_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def generate_release_notes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def generate_release_notes(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def prerelease(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @prerelease.setter
    def prerelease(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "prerelease", value)

    @property
    @pulumi.getter(name="targetCommitish")
    def target_commitish(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_commitish(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ReleaseState:
    def __init__(__self__, *,
                 assets_url: Optional[pulumi.Input[builtins.str]] = None,
                 body: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 release_id: Optional[pulumi.Input[builtins.int]] = None,
                 repository: Optional[pulumi.Input[builtins.str]] = None,
                 tag_name: Optional[pulumi.Input[builtins.str]] = None,
                 tarball_url: Optional[pulumi.Input[builtins.str]] = None,
                 target_commitish: Optional[pulumi.Input[builtins.str]] = None,
                 upload_url: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None,
                 zipball_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Release resources.
        :param pulumi.Input[builtins.str] assets_url: URL that can be provided to API calls displaying the attached assets to this release.
        :param pulumi.Input[builtins.str] body: Text describing the contents of the tag.
        :param pulumi.Input[builtins.str] created_at: This is the date of the commit used for the release, and not the date when the release was drafted or published.
        :param pulumi.Input[builtins.str] discussion_category_name: If specified, a discussion of the specified category is created and linked to the release. The value must be a category that already exists in the repository. For more information, see [Managing categories for discussions in your repository](https://docs.github.com/discussions/managing-discussions-for-your-community/managing-categories-for-discussions-in-your-repository).
        :param pulumi.Input[builtins.bool] draft: Set to `false` to create a published release.
        :param pulumi.Input[builtins.bool] generate_release_notes: Set to `true` to automatically generate the name and body for this release. If `name` is specified, the specified `name` will be used; otherwise, a name will be automatically generated. If `body` is specified, the `body` will be pre-pended to the automatically generated notes.
        :param pulumi.Input[builtins.str] html_url: URL of the release in GitHub.
        :param pulumi.Input[builtins.str] name: The name of the release.
        :param pulumi.Input[builtins.str] node_id: GraphQL global node id for use with v4 API
        :param pulumi.Input[builtins.bool] prerelease: Set to `false` to identify the release as a full release.
        :param pulumi.Input[builtins.str] published_at: This is the date when the release was published. This will be empty if the release is a draft.
        :param pulumi.Input[builtins.int] release_id: The ID of the release.
        :param pulumi.Input[builtins.str] repository: The name of the repository.
        :param pulumi.Input[builtins.str] tag_name: The name of the tag.
        :param pulumi.Input[builtins.str] tarball_url: URL that can be provided to API calls to fetch the release TAR archive.
        :param pulumi.Input[builtins.str] target_commitish: The branch name or commit SHA the tag is created from. Defaults to the default branch of the repository.
        :param pulumi.Input[builtins.str] upload_url: URL that can be provided to API calls to upload assets.
        :param pulumi.Input[builtins.str] url: URL that can be provided to API calls that reference this release.
        :param pulumi.Input[builtins.str] zipball_url: URL that can be provided to API calls to fetch the release ZIP archive.
        """
    ...
    def assets_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @assets_url.setter
    def assets_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def release_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @release_id.setter
    def release_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def tarball_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tarball_url.setter
    def tarball_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def upload_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @upload_url.setter
    def upload_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def zipball_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @zipball_url.setter
    def zipball_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Release(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            upload_url: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            zipball_url: Optional[pulumi.Input[builtins.str]] = None) -> 'Release':
        """
    ...
    @property
    @pulumi.getter(name="assetsUrl")
    def assets_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to API calls displaying the attached assets to this release.
        """
        return pulumi.get(self, "assets_url")
    ...
    @property
    @pulumi.getter(name="discussionCategoryName")
    def discussion_category_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If specified, a discussion of the specified category is created and linked to the release. The value must be a category that already exists in the repository. For more information, see [Managing categories for discussions in your repository](https://docs.github.com/discussions/managing-discussions-for-your-community/managing-categories-for-discussions-in-your-repository).
        """
        return pulumi.get(self, "discussion_category_name")
    ...
    @property
    @pulumi.getter
    def draft(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `false` to create a published release.
        """
        return pulumi.get(self, "draft")
    ...
    @property
    @pulumi.getter(name="generateReleaseNotes")
    def generate_release_notes(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to automatically generate the name and body for this release. If `name` is specified, the specified `name` will be used; otherwise, a name will be automatically generated. If `body` is specified, the `body` will be pre-pended to the automatically generated notes.
        """
        return pulumi.get(self, "generate_release_notes")
    ...
    @property
    @pulumi.getter
    def prerelease(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `false` to identify the release as a full release.
        """
        return pulumi.get(self, "prerelease")
    ...
    @property
    @pulumi.getter(name="releaseId")
    def release_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the release.
        """
        return pulumi.get(self, "release_id")
    ...
    @property
    @pulumi.getter(name="tarballUrl")
    def tarball_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to API calls to fetch the release TAR archive.
        """
        return pulumi.get(self, "tarball_url")
    ...
    @property
    @pulumi.getter(name="targetCommitish")
    def target_commitish(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The branch name or commit SHA the tag is created from. Defaults to the default branch of the repository.
        """
        return pulumi.get(self, "target_commitish")
    ...
    @property
    @pulumi.getter(name="uploadUrl")
    def upload_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to API calls to upload assets.
        """
        return pulumi.get(self, "upload_url")
    ...
    @property
    @pulumi.getter(name="zipballUrl")
    def zipball_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to API calls to fetch the release ZIP archive.
        """
        return pulumi.get(self, "zipball_url")
