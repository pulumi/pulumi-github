...
class RepositoryAutolinkReferenceArgs:
    def __init__(__self__, *,
                 key_prefix: pulumi.Input[builtins.str],
                 repository: pulumi.Input[builtins.str],
                 target_url_template: pulumi.Input[builtins.str],
                 is_alphanumeric: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a RepositoryAutolinkReference resource.
        :param pulumi.Input[builtins.str] key_prefix: This prefix appended by a number will generate a link any time it is found in an issue, pull request, or commit.
        :param pulumi.Input[builtins.str] repository: The repository of the autolink reference.
        :param pulumi.Input[builtins.str] target_url_template: The template of the target URL used for the links; must be a valid URL and contain `<num>` for the reference number
        :param pulumi.Input[builtins.bool] is_alphanumeric: Whether this autolink reference matches alphanumeric characters. If false, this autolink reference only matches numeric characters. Default is true.
        """
    ...
    def key_prefix(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @key_prefix.setter
    def key_prefix(self, value: pulumi.Input[builtins.str]):
    ...
    def target_url_template(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_url_template(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_url_template", value)

    @property
    @pulumi.getter(name="isAlphanumeric")
    def is_alphanumeric(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_alphanumeric(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RepositoryAutolinkReferenceState:
    def __init__(__self__, *,
                 ...
                 target_url_template: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering RepositoryAutolinkReference resources.
        :param pulumi.Input[builtins.str] etag: An etag representing the autolink reference object.
        :param pulumi.Input[builtins.bool] is_alphanumeric: Whether this autolink reference matches alphanumeric characters. If false, this autolink reference only matches numeric characters. Default is true.
        :param pulumi.Input[builtins.str] key_prefix: This prefix appended by a number will generate a link any time it is found in an issue, pull request, or commit.
        :param pulumi.Input[builtins.str] repository: The repository of the autolink reference.
        :param pulumi.Input[builtins.str] target_url_template: The template of the target URL used for the links; must be a valid URL and contain `<num>` for the reference number
    ...
    @property
    @pulumi.getter(name="targetUrlTemplate")
    def target_url_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The template of the target URL used for the links; must be a valid URL and contain `<num>` for the reference number
        """
        return pulumi.get(self, "target_url_template")
    ...
    @target_url_template.setter
    def target_url_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_url_template", value)
...
class RepositoryAutolinkReference(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_prefix: Optional[pulumi.Input[builtins.str]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None,
            target_url_template: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryAutolinkReference':
        """
    ...
    @property
    @pulumi.getter(name="isAlphanumeric")
    def is_alphanumeric(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether this autolink reference matches alphanumeric characters. If false, this autolink reference only matches numeric characters. Default is true.
        """
        return pulumi.get(self, "is_alphanumeric")
    ...
    @property
    @pulumi.getter(name="targetUrlTemplate")
    def target_url_template(self) -> pulumi.Output[builtins.str]:
        """
        The template of the target URL used for the links; must be a valid URL and contain `<num>` for the reference number
        """
        return pulumi.get(self, "target_url_template")
