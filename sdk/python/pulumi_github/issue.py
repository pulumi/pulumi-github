...
class IssueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] labels: List of labels to attach to the issue
        :param pulumi.Input[_builtins.int] milestone_number: Milestone number to assign to the issue
        """
...
class _IssueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] labels: List of labels to attach to the issue
        :param pulumi.Input[_builtins.int] milestone_number: Milestone number to assign to the issue
        :param pulumi.Input[_builtins.int] number: (Computed) - The issue number
        :param pulumi.Input[_builtins.str] repository: The GitHub repository name
        :param pulumi.Input[_builtins.str] title: Title of the issue
        """
        if assignees is not None:
...
class Issue(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def assignees(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of Logins to assign the to the issue
        """
        return pulumi.get(self, "assignees")
    ...
    @_builtins.property
    @pulumi.getter(name="milestoneNumber")
    def milestone_number(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Milestone number to assign to the issue
        """
        return pulumi.get(self, "milestone_number")
