...
class IssueArgs:
    def __init__(__self__, *,
                 ...
                 milestone_number: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] title: Title of the issue
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] assignees: List of Logins to assign the to the issue
        :param pulumi.Input[builtins.str] body: Body of the issue
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] labels: List of labels to attach to the issue
        :param pulumi.Input[builtins.int] milestone_number: Milestone number to assign to the issue
        """
    ...
    def milestone_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def milestone_number(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _IssueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] assignees: List of Logins to assign the to the issue
        :param pulumi.Input[builtins.str] body: Body of the issue
        :param pulumi.Input[builtins.int] issue_id: (Computed) - The issue id
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] labels: List of labels to attach to the issue
        :param pulumi.Input[builtins.int] milestone_number: Milestone number to assign to the issue
        :param pulumi.Input[builtins.int] number: (Computed) - The issue number
        :param pulumi.Input[builtins.str] repository: The GitHub repository name
        :param pulumi.Input[builtins.str] title: Title of the issue
        """
        if assignees is not None:
...
@pulumi.type_token("github:index/issue:Issue")
class Issue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            number: Optional[pulumi.Input[builtins.int]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None,
            title: Optional[pulumi.Input[builtins.str]] = None) -> 'Issue':
        """
    ...
    @property
    @pulumi.getter(name="milestoneNumber")
    def milestone_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Milestone number to assign to the issue
        """
        return pulumi.get(self, "milestone_number")
