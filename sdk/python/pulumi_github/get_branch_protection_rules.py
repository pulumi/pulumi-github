...
def get_branch_protection_rules(repository: Optional[builtins.str] = None,
...
def get_branch_protection_rules_output(repository: Optional[pulumi.Input[builtins.str]] = None,
