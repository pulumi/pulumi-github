...
class RepositoryCustomPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] property_name: Name of the custom property. Note that a pre-requisiste for this resource is that a custom property of this name has already been defined on the organization level
        :param pulumi.Input[builtins.str] property_type: Type of the custom property. Can be one of `single_select`, `multi_select`, `string`, or `true_false`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] property_values: Value of the custom property in the form of an array. Properties of type `single_select`, `string`, and `true_false` are represented as a string array of length 1
...
class RepositoryCustomProperty(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            property_type: Optional[pulumi.Input[builtins.str]] = None,
            property_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            repository: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryCustomProperty':
        """
    ...
    @property
    @pulumi.getter(name="propertyName")
    def property_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the custom property. Note that a pre-requisiste for this resource is that a custom property of this name has already been defined on the organization level
        """
        return pulumi.get(self, "property_name")
    ...
    @property
    @pulumi.getter(name="propertyType")
    def property_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of the custom property. Can be one of `single_select`, `multi_select`, `string`, or `true_false`
        """
        return pulumi.get(self, "property_type")
    ...
    @property
    @pulumi.getter(name="propertyValues")
    def property_values(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Value of the custom property in the form of an array. Properties of type `single_select`, `string`, and `true_false` are represented as a string array of length 1
        """
        return pulumi.get(self, "property_values")
