...
class GetUserResult:
    ...
    @property
    @pulumi.getter
    def followers(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter
    def following(self) -> builtins.int:
        """
    ...
    def gpg_keys(self) -> Sequence[builtins.str]:
        """
    ...
    def public_gists(self) -> builtins.int:
        """
    ...
    def public_repos(self) -> builtins.int:
        """
...
def get_user(username: Optional[builtins.str] = None,
    ...
    :param builtins.str username: The username. Use an empty string `""` to retrieve information about the currently authenticated user.
    """
    __args__ = dict()
