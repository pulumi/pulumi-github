...
class ActionsEnvironmentVariable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        The following import imports a GitHub actions environment variable named `myvariable` for the repo `myrepo` and environment `myenv` to a `ActionsEnvironmentVariable` resource named `example`.
    ...
    def get(resource_name: str,
            ...
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            value: pulumi.Input[Optional[_builtins.str]] = None,
            variable_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'ActionsEnvironmentVariable':
        """
