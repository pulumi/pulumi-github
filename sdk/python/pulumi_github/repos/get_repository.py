...
async def get_repository(full_name=None,name=None,opts=None):
    """
    ...
    __args__['name'] = name
    __ret__ = await pulumi.runtime.invoke('github:repos/getRepository:getRepository', __args__, opts=opts)
