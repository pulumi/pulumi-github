...
class RepositoryEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] repository: The repository of the environment.
        :param pulumi.Input[builtins.bool] can_admins_bypass: Can repository admins bypass the environment protections.  Defaults to `true`.
        ...
        :param pulumi.Input[builtins.bool] prevent_self_review: Whether or not a user who created the job is prevented from approving their own job. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.int] wait_timer: Amount of time to delay a job after the job is initially triggered.
        """
    ...
    def can_admins_bypass(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def can_admins_bypass(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def prevent_self_review(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def prevent_self_review(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def wait_timer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @wait_timer.setter
    def wait_timer(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RepositoryEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repository: Optional[pulumi.Input[builtins.str]] = None,
            reviewers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RepositoryEnvironmentReviewerArgs', 'RepositoryEnvironmentReviewerArgsDict']]]]] = None,
            wait_timer: Optional[pulumi.Input[builtins.int]] = None) -> 'RepositoryEnvironment':
        """
    ...
    @property
    @pulumi.getter(name="canAdminsBypass")
    def can_admins_bypass(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Can repository admins bypass the environment protections.  Defaults to `true`.
        """
        return pulumi.get(self, "can_admins_bypass")
    ...
    @property
    @pulumi.getter(name="preventSelfReview")
    def prevent_self_review(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not a user who created the job is prevented from approving their own job. Defaults to `false`.
        """
        return pulumi.get(self, "prevent_self_review")
    ...
    @property
    @pulumi.getter(name="waitTimer")
    def wait_timer(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Amount of time to delay a job after the job is initially triggered.
        """
        return pulumi.get(self, "wait_timer")
