...
class OrganizationRulesetArgs:
    def __init__(__self__, *,
        ...
        """
        OrganizationRulesetArgs._configure(
...
class _OrganizationRulesetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] target: (String) Possible values are `branch` and `tag`.
        """
        _OrganizationRulesetState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bypass_actors=bypass_actors,
            conditions=conditions,
            enforcement=enforcement,
...
class OrganizationRuleset(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OrganizationRulesetArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if conditions is not None and not isinstance(conditions, OrganizationRulesetConditionsArgs):
                conditions = conditions or {}
                def _setter(key, value):
                    conditions[key] = value
                OrganizationRulesetConditionsArgs._configure(_setter, **conditions)
            ...
            if rules is not None and not isinstance(rules, OrganizationRulesetRulesArgs):
                rules = rules or {}
                def _setter(key, value):
                    rules[key] = value
                OrganizationRulesetRulesArgs._configure(_setter, **rules)
