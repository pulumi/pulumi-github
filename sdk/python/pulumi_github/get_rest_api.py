...
class GetRestApiResult:
    ...
    @_builtins.property
    @pulumi.getter
    def headers(self) -> _builtins.str:
        """
...
def get_rest_api(endpoint: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint: REST API endpoint to send the GET request to.
    """
    __args__ = dict()
