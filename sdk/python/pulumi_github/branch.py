...
class _BranchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repository: The GitHub repository name.
        :param pulumi.Input[_builtins.str] sha: A string storing the reference's `HEAD` commit's SHA1.
        :param pulumi.Input[_builtins.str] source_branch: The branch name to start from. Defaults to `main`.
        :param pulumi.Input[_builtins.str] source_sha: The commit hash to start from. Defaults to the tip of `source_branch`. If provided, `source_branch` is ignored.
        """
...
class Branch(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sourceBranch")
    def source_branch(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The branch name to start from. Defaults to `main`.
        """
        return pulumi.get(self, "source_branch")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceSha")
    def source_sha(self) -> pulumi.Output[_builtins.str]:
        """
        The commit hash to start from. Defaults to the tip of `source_branch`. If provided, `source_branch` is ignored.
        """
        return pulumi.get(self, "source_sha")
