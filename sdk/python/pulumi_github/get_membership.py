...
def get_membership(organization: Optional[_builtins.str] = None,
    ...
    :param _builtins.str organization: The organization to check for the above username.
    :param _builtins.str username: The username to lookup in the organization.
    """
    __args__ = dict()
