...
class RepositoryArgs:
    def __init__(__self__, *,
                 allow_auto_merge: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_merge_commit: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_rebase_merge: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_squash_merge: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_update_branch: Optional[pulumi.Input[builtins.bool]] = None,
                 archive_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 archived: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_init: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 gitignore_template: Optional[pulumi.Input[builtins.str]] = None,
                 has_discussions: Optional[pulumi.Input[builtins.bool]] = None,
                 has_downloads: Optional[pulumi.Input[builtins.bool]] = None,
                 has_issues: Optional[pulumi.Input[builtins.bool]] = None,
                 has_projects: Optional[pulumi.Input[builtins.bool]] = None,
                 has_wiki: Optional[pulumi.Input[builtins.bool]] = None,
                 homepage_url: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_vulnerability_alerts_during_read: Optional[pulumi.Input[builtins.bool]] = None,
                 is_template: Optional[pulumi.Input[builtins.bool]] = None,
                 license_template: Optional[pulumi.Input[builtins.str]] = None,
                 merge_commit_message: Optional[pulumi.Input[builtins.str]] = None,
                 merge_commit_title: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 squash_merge_commit_message: Optional[pulumi.Input[builtins.str]] = None,
                 squash_merge_commit_title: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vulnerability_alerts: Optional[pulumi.Input[builtins.bool]] = None,
                 web_commit_signoff_required: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Repository resource.
        :param pulumi.Input[builtins.bool] allow_auto_merge: Set to `true` to allow auto-merging pull requests on the repository.
        :param pulumi.Input[builtins.bool] allow_merge_commit: Set to `false` to disable merge commits on the repository.
        :param pulumi.Input[builtins.bool] allow_rebase_merge: Set to `false` to disable rebase merges on the repository.
        :param pulumi.Input[builtins.bool] allow_squash_merge: Set to `false` to disable squash merges on the repository.
        :param pulumi.Input[builtins.bool] allow_update_branch: Set to `true` to always suggest updating pull request branches.
        :param pulumi.Input[builtins.bool] archive_on_destroy: Set to `true` to archive the repository instead of deleting on destroy.
        :param pulumi.Input[builtins.bool] archived: Specifies if the repository should be archived. Defaults to `false`. **NOTE** Currently, the API does not support unarchiving.
        :param pulumi.Input[builtins.bool] auto_init: Set to `true` to produce an initial commit in the repository.
        :param pulumi.Input[builtins.str] default_branch: (Deprecated: Use `BranchDefault` resource instead) The name of the default branch of the repository. **NOTE:** This can only be set after a repository has already been created,
               and after a correct reference has been created for the target branch inside the repository. This means a user will have to omit this parameter from the
               initial repository creation and create the target branch inside of the repository prior to setting this attribute.
        :param pulumi.Input[builtins.bool] delete_branch_on_merge: Automatically delete head branch after a pull request is merged. Defaults to `false`.
        :param pulumi.Input[builtins.str] description: A description of the repository.
        :param pulumi.Input[builtins.str] gitignore_template: Use the [name of the template](https://github.com/github/gitignore) without the extension. For example, "Haskell".
        :param pulumi.Input[builtins.bool] has_discussions: Set to `true` to enable GitHub Discussions on the repository. Defaults to `false`.
        :param pulumi.Input[builtins.bool] has_downloads: Set to `true` to enable the (deprecated) downloads features on the repository.
        :param pulumi.Input[builtins.bool] has_issues: Set to `true` to enable the GitHub Issues features
               on the repository.
        :param pulumi.Input[builtins.bool] has_projects: Set to `true` to enable the GitHub Projects features on the repository. Per the GitHub [documentation](https://developer.github.com/v3/repos/#create) when in an organization that has disabled repository projects it will default to `false` and will otherwise default to `true`. If you specify `true` when it has been disabled it will return an error.
        :param pulumi.Input[builtins.bool] has_wiki: Set to `true` to enable the GitHub Wiki features on
               the repository.
        :param pulumi.Input[builtins.str] homepage_url: URL of a page describing the project.
        :param pulumi.Input[builtins.bool] ignore_vulnerability_alerts_during_read: Set to `true` to not call the vulnerability alerts endpoint so the resource can also be used without admin permissions during read.
        :param pulumi.Input[builtins.bool] is_template: Set to `true` to tell GitHub that this is a template repository.
        :param pulumi.Input[builtins.str] license_template: Use the [name of the template](https://github.com/github/choosealicense.com/tree/gh-pages/_licenses) without the extension. For example, "mit" or "mpl-2.0".
        :param pulumi.Input[builtins.str] merge_commit_message: Can be `PR_BODY`, `PR_TITLE`, or `BLANK` for a default merge commit message. Applicable only if `allow_merge_commit` is `true`.
        :param pulumi.Input[builtins.str] merge_commit_title: Can be `PR_TITLE` or `MERGE_MESSAGE` for a default merge commit title. Applicable only if `allow_merge_commit` is `true`.
        ...
        :param pulumi.Input[builtins.bool] private: Set to `true` to create a private repository.
        ...
        :param pulumi.Input[builtins.str] squash_merge_commit_message: Can be `PR_BODY`, `COMMIT_MESSAGES`, or `BLANK` for a default squash merge commit message. Applicable only if `allow_squash_merge` is `true`.
        :param pulumi.Input[builtins.str] squash_merge_commit_title: Can be `PR_TITLE` or `COMMIT_OR_PR_TITLE` for a default squash merge commit title. Applicable only if `allow_squash_merge` is `true`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] topics: The list of topics of the repository.
        :param pulumi.Input[builtins.str] visibility: Can be `public` or `private`. If your organization is associated with an enterprise account using GitHub Enterprise Cloud or GitHub Enterprise Server 2.20+, visibility can also be `internal`. The `visibility` parameter overrides the `private` parameter.
        :param pulumi.Input[builtins.bool] vulnerability_alerts: Set to `true` to enable security alerts for vulnerable dependencies. Enabling requires alerts to be enabled on the owner level. (Note for importing: GitHub enables the alerts on public repos but disables them on private repos by default.) See [GitHub Documentation](https://help.github.com/en/github/managing-security-vulnerabilities/about-security-alerts-for-vulnerable-dependencies) for details. Note that vulnerability alerts have not been successfully tested on any GitHub Enterprise instance and may be unavailable in those settings.
        :param pulumi.Input[builtins.bool] web_commit_signoff_required: Require contributors to sign off on web-based commits. See more [here](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/managing-repository-settings/managing-the-commit-signoff-policy-for-your-repository). Defaults to `false`.
        """
    ...
    def allow_auto_merge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_auto_merge(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_auto_merge", value)

    @property
    @pulumi.getter(name="allowMergeCommit")
    def allow_merge_commit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_merge_commit(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_merge_commit", value)

    @property
    @pulumi.getter(name="allowRebaseMerge")
    def allow_rebase_merge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_rebase_merge(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_rebase_merge", value)

    @property
    @pulumi.getter(name="allowSquashMerge")
    def allow_squash_merge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_squash_merge(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_squash_merge", value)

    @property
    @pulumi.getter(name="allowUpdateBranch")
    def allow_update_branch(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_update_branch(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def auto_init(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @auto_init.setter
    def auto_init(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gitignore_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gitignore_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gitignore_template", value)

    @property
    @pulumi.getter(name="hasDiscussions")
    def has_discussions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_discussions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_discussions", value)

    @property
    @pulumi.getter(name="hasDownloads")
    def has_downloads(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_downloads(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_downloads", value)

    @property
    @pulumi.getter(name="hasIssues")
    def has_issues(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_issues.setter
    def has_issues(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_issues", value)

    @property
    @pulumi.getter(name="hasProjects")
    def has_projects(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_projects.setter
    def has_projects(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_projects", value)

    @property
    @pulumi.getter(name="hasWiki")
    def has_wiki(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_wiki.setter
    def has_wiki(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ignore_vulnerability_alerts_during_read(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_vulnerability_alerts_during_read(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def license_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def license_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "license_template", value)

    @property
    @pulumi.getter(name="mergeCommitMessage")
    def merge_commit_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def merge_commit_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "merge_commit_message", value)

    @property
    @pulumi.getter(name="mergeCommitTitle")
    def merge_commit_title(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def merge_commit_title(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def squash_merge_commit_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def squash_merge_commit_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "squash_merge_commit_message", value)

    @property
    @pulumi.getter(name="squashMergeCommitTitle")
    def squash_merge_commit_title(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def squash_merge_commit_title(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vulnerability_alerts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def vulnerability_alerts(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RepositoryState:
    def __init__(__self__, *,
                 ...
                 git_clone_url: Optional[pulumi.Input[builtins.str]] = None,
                 gitignore_template: Optional[pulumi.Input[builtins.str]] = None,
                 has_discussions: Optional[pulumi.Input[builtins.bool]] = None,
                 has_downloads: Optional[pulumi.Input[builtins.bool]] = None,
                 has_issues: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 http_clone_url: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_vulnerability_alerts_during_read: Optional[pulumi.Input[builtins.bool]] = None,
                 is_template: Optional[pulumi.Input[builtins.bool]] = None,
                 license_template: Optional[pulumi.Input[builtins.str]] = None,
                 merge_commit_message: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pages: Optional[pulumi.Input['RepositoryPagesArgs']] = None,
                 primary_language: Optional[pulumi.Input[builtins.str]] = None,
                 private: Optional[pulumi.Input[builtins.bool]] = None,
                 repo_id: Optional[pulumi.Input[builtins.int]] = None,
                 security_and_analysis: Optional[pulumi.Input['RepositorySecurityAndAnalysisArgs']] = None,
                 squash_merge_commit_message: Optional[pulumi.Input[builtins.str]] = None,
                 squash_merge_commit_title: Optional[pulumi.Input[builtins.str]] = None,
                 ssh_clone_url: Optional[pulumi.Input[builtins.str]] = None,
                 svn_url: Optional[pulumi.Input[builtins.str]] = None,
                 template: Optional[pulumi.Input['RepositoryTemplateArgs']] = None,
                 topics: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 visibility: Optional[pulumi.Input[builtins.str]] = None,
                 vulnerability_alerts: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] delete_branch_on_merge: Automatically delete head branch after a pull request is merged. Defaults to `false`.
        :param pulumi.Input[builtins.str] description: A description of the repository.
        :param pulumi.Input[builtins.str] full_name: A string of the form "orgname/reponame".
        :param pulumi.Input[builtins.str] git_clone_url: URL that can be provided to `git clone` to clone the repository anonymously via the git protocol.
        :param pulumi.Input[builtins.str] gitignore_template: Use the [name of the template](https://github.com/github/gitignore) without the extension. For example, "Haskell".
        :param pulumi.Input[builtins.bool] has_discussions: Set to `true` to enable GitHub Discussions on the repository. Defaults to `false`.
        :param pulumi.Input[builtins.bool] has_downloads: Set to `true` to enable the (deprecated) downloads features on the repository.
        :param pulumi.Input[builtins.bool] has_issues: Set to `true` to enable the GitHub Issues features
        ...
        :param pulumi.Input[builtins.str] http_clone_url: URL that can be provided to `git clone` to clone the repository via HTTPS.
        :param pulumi.Input[builtins.bool] ignore_vulnerability_alerts_during_read: Set to `true` to not call the vulnerability alerts endpoint so the resource can also be used without admin permissions during read.
        :param pulumi.Input[builtins.bool] is_template: Set to `true` to tell GitHub that this is a template repository.
        :param pulumi.Input[builtins.str] license_template: Use the [name of the template](https://github.com/github/choosealicense.com/tree/gh-pages/_licenses) without the extension. For example, "mit" or "mpl-2.0".
        :param pulumi.Input[builtins.str] merge_commit_message: Can be `PR_BODY`, `PR_TITLE`, or `BLANK` for a default merge commit message. Applicable only if `allow_merge_commit` is `true`.
        :param pulumi.Input[builtins.str] merge_commit_title: Can be `PR_TITLE` or `MERGE_MESSAGE` for a default merge commit title. Applicable only if `allow_merge_commit` is `true`.
        :param pulumi.Input[builtins.str] name: The name of the repository.
        :param pulumi.Input[builtins.str] node_id: GraphQL global node id for use with v4 API
        :param pulumi.Input['RepositoryPagesArgs'] pages: The repository's GitHub Pages configuration. See GitHub Pages Configuration below for details.
        :param pulumi.Input[builtins.str] primary_language: The primary language used in the repository.
        :param pulumi.Input[builtins.bool] private: Set to `true` to create a private repository.
               Repositories are created as public (e.g. open source) by default.
        :param pulumi.Input[builtins.int] repo_id: GitHub ID for the repository
        :param pulumi.Input['RepositorySecurityAndAnalysisArgs'] security_and_analysis: The repository's [security and analysis](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/enabling-features-for-your-repository/managing-security-and-analysis-settings-for-your-repository) configuration. See Security and Analysis Configuration below for details.
        :param pulumi.Input[builtins.str] squash_merge_commit_message: Can be `PR_BODY`, `COMMIT_MESSAGES`, or `BLANK` for a default squash merge commit message. Applicable only if `allow_squash_merge` is `true`.
        :param pulumi.Input[builtins.str] squash_merge_commit_title: Can be `PR_TITLE` or `COMMIT_OR_PR_TITLE` for a default squash merge commit title. Applicable only if `allow_squash_merge` is `true`.
        :param pulumi.Input[builtins.str] ssh_clone_url: URL that can be provided to `git clone` to clone the repository via SSH.
        :param pulumi.Input[builtins.str] svn_url: URL that can be provided to `svn checkout` to check out the repository via GitHub's Subversion protocol emulation.
        :param pulumi.Input['RepositoryTemplateArgs'] template: Use a template repository to create this resource. See Template Repositories below for details.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] topics: The list of topics of the repository.
        :param pulumi.Input[builtins.str] visibility: Can be `public` or `private`. If your organization is associated with an enterprise account using GitHub Enterprise Cloud or GitHub Enterprise Server 2.20+, visibility can also be `internal`. The `visibility` parameter overrides the `private` parameter.
        :param pulumi.Input[builtins.bool] vulnerability_alerts: Set to `true` to enable security alerts for vulnerable dependencies. Enabling requires alerts to be enabled on the owner level. (Note for importing: GitHub enables the alerts on public repos but disables them on private repos by default.) See [GitHub Documentation](https://help.github.com/en/github/managing-security-vulnerabilities/about-security-alerts-for-vulnerable-dependencies) for details. Note that vulnerability alerts have not been successfully tested on any GitHub Enterprise instance and may be unavailable in those settings.
    ...
    def git_clone_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def git_clone_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def http_clone_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def http_clone_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def primary_language(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_language(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def repo_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @repo_id.setter
    def repo_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ssh_clone_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ssh_clone_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssh_clone_url", value)

    @property
    @pulumi.getter(name="svnUrl")
    def svn_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @svn_url.setter
    def svn_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Repository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            visibility: Optional[pulumi.Input[builtins.str]] = None,
            vulnerability_alerts: Optional[pulumi.Input[builtins.bool]] = None,
            web_commit_signoff_required: Optional[pulumi.Input[builtins.bool]] = None) -> 'Repository':
        """
    ...
    @property
    @pulumi.getter(name="allowAutoMerge")
    def allow_auto_merge(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to allow auto-merging pull requests on the repository.
        """
        return pulumi.get(self, "allow_auto_merge")
    ...
    @property
    @pulumi.getter(name="allowMergeCommit")
    def allow_merge_commit(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `false` to disable merge commits on the repository.
        """
        return pulumi.get(self, "allow_merge_commit")
    ...
    @property
    @pulumi.getter(name="allowRebaseMerge")
    def allow_rebase_merge(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `false` to disable rebase merges on the repository.
        """
        return pulumi.get(self, "allow_rebase_merge")
    ...
    @property
    @pulumi.getter(name="allowSquashMerge")
    def allow_squash_merge(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `false` to disable squash merges on the repository.
        """
        return pulumi.get(self, "allow_squash_merge")
    ...
    @property
    @pulumi.getter(name="allowUpdateBranch")
    def allow_update_branch(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to always suggest updating pull request branches.
        """
        return pulumi.get(self, "allow_update_branch")
    ...
    @property
    @pulumi.getter(name="autoInit")
    def auto_init(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to produce an initial commit in the repository.
        """
        return pulumi.get(self, "auto_init")
    ...
    @property
    @pulumi.getter(name="deleteBranchOnMerge")
    def delete_branch_on_merge(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Automatically delete head branch after a pull request is merged. Defaults to `false`.
        """
        return pulumi.get(self, "delete_branch_on_merge")
    ...
    @property
    @pulumi.getter(name="gitCloneUrl")
    def git_clone_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to `git clone` to clone the repository anonymously via the git protocol.
        """
        return pulumi.get(self, "git_clone_url")
    ...
    @property
    @pulumi.getter(name="gitignoreTemplate")
    def gitignore_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Use the [name of the template](https://github.com/github/gitignore) without the extension. For example, "Haskell".
        """
        return pulumi.get(self, "gitignore_template")
    ...
    @property
    @pulumi.getter(name="hasDiscussions")
    def has_discussions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to enable GitHub Discussions on the repository. Defaults to `false`.
        """
        return pulumi.get(self, "has_discussions")
    ...
    @property
    @pulumi.getter(name="hasDownloads")
    def has_downloads(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to enable the (deprecated) downloads features on the repository.
        """
        return pulumi.get(self, "has_downloads")
    ...
    @property
    @pulumi.getter(name="hasIssues")
    def has_issues(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to enable the GitHub Issues features
        on the repository.
        """
    ...
    @property
    @pulumi.getter(name="hasProjects")
    def has_projects(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to enable the GitHub Projects features on the repository. Per the GitHub [documentation](https://developer.github.com/v3/repos/#create) when in an organization that has disabled repository projects it will default to `false` and will otherwise default to `true`. If you specify `true` when it has been disabled it will return an error.
        """
        return pulumi.get(self, "has_projects")
    ...
    @property
    @pulumi.getter(name="hasWiki")
    def has_wiki(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to enable the GitHub Wiki features on
        the repository.
        """
    ...
    @property
    @pulumi.getter(name="httpCloneUrl")
    def http_clone_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to `git clone` to clone the repository via HTTPS.
        """
        return pulumi.get(self, "http_clone_url")
    ...
    @property
    @pulumi.getter(name="ignoreVulnerabilityAlertsDuringRead")
    def ignore_vulnerability_alerts_during_read(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to not call the vulnerability alerts endpoint so the resource can also be used without admin permissions during read.
        """
        return pulumi.get(self, "ignore_vulnerability_alerts_during_read")
    ...
    @property
    @pulumi.getter(name="isTemplate")
    def is_template(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to tell GitHub that this is a template repository.
        """
        return pulumi.get(self, "is_template")
    ...
    @property
    @pulumi.getter(name="licenseTemplate")
    def license_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Use the [name of the template](https://github.com/github/choosealicense.com/tree/gh-pages/_licenses) without the extension. For example, "mit" or "mpl-2.0".
        """
        return pulumi.get(self, "license_template")
    ...
    @property
    @pulumi.getter(name="mergeCommitMessage")
    def merge_commit_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be `PR_BODY`, `PR_TITLE`, or `BLANK` for a default merge commit message. Applicable only if `allow_merge_commit` is `true`.
        """
        return pulumi.get(self, "merge_commit_message")
    ...
    @property
    @pulumi.getter(name="mergeCommitTitle")
    def merge_commit_title(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be `PR_TITLE` or `MERGE_MESSAGE` for a default merge commit title. Applicable only if `allow_merge_commit` is `true`.
        """
        return pulumi.get(self, "merge_commit_title")
    ...
    @property
    @pulumi.getter(name="primaryLanguage")
    def primary_language(self) -> pulumi.Output[builtins.str]:
        """
        The primary language used in the repository.
        """
        return pulumi.get(self, "primary_language")
    ...
    @pulumi.getter
    @_utilities.deprecated("""use visibility instead""")
    def private(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to create a private repository.
        Repositories are created as public (e.g. open source) by default.
        """
    ...
    @property
    @pulumi.getter(name="repoId")
    def repo_id(self) -> pulumi.Output[builtins.int]:
        """
        GitHub ID for the repository
        """
        return pulumi.get(self, "repo_id")
    ...
    @property
    @pulumi.getter(name="squashMergeCommitMessage")
    def squash_merge_commit_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be `PR_BODY`, `COMMIT_MESSAGES`, or `BLANK` for a default squash merge commit message. Applicable only if `allow_squash_merge` is `true`.
        """
        return pulumi.get(self, "squash_merge_commit_message")
    ...
    @property
    @pulumi.getter(name="squashMergeCommitTitle")
    def squash_merge_commit_title(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be `PR_TITLE` or `COMMIT_OR_PR_TITLE` for a default squash merge commit title. Applicable only if `allow_squash_merge` is `true`.
        """
        return pulumi.get(self, "squash_merge_commit_title")
    ...
    @property
    @pulumi.getter(name="sshCloneUrl")
    def ssh_clone_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to `git clone` to clone the repository via SSH.
        """
        return pulumi.get(self, "ssh_clone_url")
    ...
    @property
    @pulumi.getter(name="svnUrl")
    def svn_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that can be provided to `svn checkout` to check out the repository via GitHub's Subversion protocol emulation.
        """
        return pulumi.get(self, "svn_url")
    ...
    @property
    @pulumi.getter(name="vulnerabilityAlerts")
    def vulnerability_alerts(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` to enable security alerts for vulnerable dependencies. Enabling requires alerts to be enabled on the owner level. (Note for importing: GitHub enables the alerts on public repos but disables them on private repos by default.) See [GitHub Documentation](https://help.github.com/en/github/managing-security-vulnerabilities/about-security-alerts-for-vulnerable-dependencies) for details. Note that vulnerability alerts have not been successfully tested on any GitHub Enterprise instance and may be unavailable in those settings.
        """
        return pulumi.get(self, "vulnerability_alerts")
