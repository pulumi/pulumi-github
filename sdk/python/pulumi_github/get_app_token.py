...
def get_app_token(app_id: Optional[builtins.str] = None,
                  installation_id: Optional[builtins.str] = None,
                  pem_file: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: This is the ID of the GitHub App.
    :param builtins.str installation_id: This is the ID of the GitHub App installation.
    :param builtins.str pem_file: This is the contents of the GitHub App private key PEM file.
    """
    __args__ = dict()
...
def get_app_token_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
                         installation_id: Optional[pulumi.Input[builtins.str]] = None,
                         pem_file: Optional[pulumi.Input[builtins.str]] = None,
