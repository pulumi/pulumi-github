...
def get_user_external_identity(username: Optional[builtins.str] = None,
    ...
    :param builtins.str username: The username of the member to fetch external identity for.
    """
    __args__ = dict()
...
def get_user_external_identity_output(username: Optional[pulumi.Input[builtins.str]] = None,
