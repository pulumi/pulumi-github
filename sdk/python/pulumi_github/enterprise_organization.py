...
class EnterpriseOrganizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: The display name of the organization.
    ...
    def admin_logins(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @admin_logins.setter
    def admin_logins(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class EnterpriseOrganization(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="adminLogins")
    def admin_logins(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of organization owner usernames.
        """
        return pulumi.get(self, "admin_logins")
