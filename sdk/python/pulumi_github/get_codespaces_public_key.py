...
def get_codespaces_public_key(repository: Optional[builtins.str] = None,
...
def get_codespaces_public_key_output(repository: Optional[pulumi.Input[builtins.str]] = None,
