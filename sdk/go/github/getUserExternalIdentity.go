...
func (o GetUserExternalIdentityResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetUserExternalIdentityResult] {
	return pulumix.Output[GetUserExternalIdentityResult]{
