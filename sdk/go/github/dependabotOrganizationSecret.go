...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := github.NewDependabotOrganizationSecret(ctx, "example_allow_drift", &github.DependabotOrganizationSecretArgs{
//				SecretName:     pulumi.String("example_secret_name"),
//				Visibility:     pulumi.String("all"),
...
// ### Import Block
//
// The following import imports a GitHub Dependabot organization secret named `mysecret` to a `DependabotOrganizationSecret` resource named `example`.
//
// ### Import Command
//
