...
func NewWebhook(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	inputs["url"] = nil
	s, err := ctx.RegisterResource("github:repos/webhook:Webhook", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetWebhook(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("github:repos/webhook:Webhook", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Webhook{s: s}, nil
...
func (r *Webhook) Repository() *pulumi.StringOutput {
