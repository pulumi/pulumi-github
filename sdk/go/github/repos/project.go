...
func NewProject(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	inputs["url"] = nil
	s, err := ctx.RegisterResource("github:repos/project:Project", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetProject(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("github:repos/project:Project", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Project{s: s}, nil
...
func (r *Project) Repository() *pulumi.StringOutput {
