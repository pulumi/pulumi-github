...
func (o LookupRepositoryPullRequestResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRepositoryPullRequestResult] {
	return pulumix.Output[LookupRepositoryPullRequestResult]{
