...
//			_, err := github.GetBranch(ctx, &github.LookupBranchArgs{
//				Repository: "example",
//				Branch:     "development",
//			}, nil)
//			if err != nil {
...
func LookupBranchOutput(ctx *pulumi.Context, args LookupBranchOutputArgs, opts ...pulumi.InvokeOption) LookupBranchResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBranchResultOutput, error) {
			...
			return ctx.InvokeOutput("github:index/getBranch:getBranch", args, LookupBranchResultOutput{}, options).(LookupBranchResultOutput), nil
